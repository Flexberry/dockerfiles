    ...
    public class DataObjectEdmModel : EdmModel
    {
        ...
        internal void AddUserFunction(Function function)
        {
            ...
            foreach (var parameter in function.ParametersTypes.Keys)
            {
                ...
                var edmParameterType = EdmLibHelpers.GetEdmPrimitiveTypeOrNull(paramType);
        ...
        {
            IEdmType edmType = EdmLibHelpers.GetEdmPrimitiveTypeOrNull(clrType);
            if (edmType != null)
            {
        ...
        {
            EdmFunction edmFunction;
            var edmReturnType = EdmLibHelpers.GetEdmPrimitiveTypeOrNull(typeof(bool));
            edmFunction = new EdmFunction("geo", "intersects", new EdmPrimitiveTypeReference(edmReturnType, false), false, null, true);
            AddElement(edmFunction);
            var edmParameterType = EdmLibHelpers.GetEdmPrimitiveTypeOrNull(typeof(Geography));
        ...
        private void RegisterGeomIntersectsFunction()
        {
            ...
            AddElement(edmFunction);
            var edmParameterType = EdmLibHelpers.GetEdmPrimitiveTypeOrNull(typeof(Geometry));
