...
#### Работа из встроенного терминального клиента clickhouse-client
...
Для установки параметров файлов конфигурации определите в среде две переменные:
...
Если в XML-файле конфигурации указанный тег встречается неоднократно в разном контексте
