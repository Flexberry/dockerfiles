...
```
имя_таблицы1[/ключевое_поле11[,ключевое_поле12...]],[имя_таблицы2[/ключевое_поле21[,ключевое_поле22...]]]...
```
Если не указан `список ключевых полей` в качестве ключевого поля принимается пол с именем `primarykey`.
