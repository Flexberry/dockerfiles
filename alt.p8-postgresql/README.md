...
Но проблема в  том, что в этом режиме не произаолится подстановка переменных среды из файла конфигурации `.env`.
...
выведет результат подстановки на страндартный выход, который будет использован 
