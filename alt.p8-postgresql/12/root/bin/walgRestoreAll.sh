...
then
  ...
  POSTGRES_PARAMS="-c restore_command='/bin/wal-fetch.sh %f %p' -c recovery_target_timeline=latest recovery_target_action=shutdown recovery_target_time=$BACKUP_WALG" 
