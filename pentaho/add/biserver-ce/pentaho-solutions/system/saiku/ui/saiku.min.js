...
SaikuOlapQueryHelper.prototype.setSelectionsForParameter=function(a,b){var c=this.model().queryModel.axes;_.each(c,function(c){_.each(c.hierarchies,function(c){_.each(c.levels,function(c){if(c.selection&&c.selection.parameterName&&c.selection.parameterName===a)return c.selection.members=b,!1})})})};
SaikuOlapQueryHelper.prototype.removeParameter=function(a,b){if((a=this.getHierarchy(a))&&a.levels.hasOwnProperty(b)){var c=a.levels[b].hasOwnProperty("selection")?a.levels[b].selection.parameterName:null;delete this.model().parameters[c]}};var buildUniqueName=function(a,b){return a.hierarchy.name+".["+a.level.name+"].["+b+"]"};
SaikuOlapQueryHelper.prototype.addtoSelection=function(a,b){void 0===b.level.selection.members&&(b.selection.members=[]);var c=!1;_.each(b.level.selection.members,function(d){buildUniqueName(b,d.name);buildUniqueName(b,d.name)===buildUniqueName(b,a)&&(c=!0)});c||b.level.selection.members.push({uniqueName:buildUniqueName(b,a),caption:a})};SaikuOlapQueryHelper.prototype.includeCmember=function(a,b){var c=this.getHierarchy(a);c&&(c.cmembers[b]=b)};
...
SaikuOlapQueryHelper.prototype.removeLevel=function(a,b){var c=a;(a=this.getHierarchy(a))&&a.levels.hasOwnProperty(b)&&(delete a.levels[b],a&&_.isEmpty(a.levels)&&this.removeHierarchy(c))};SaikuOlapQueryHelper.prototype.removeLevelCalculatedMember=function(a,b){(a=this.getHierarchy(a))&&a.cmembers.hasOwnProperty(b)&&delete a.cmembers[b]};SaikuOlapQueryHelper.prototype.removeAllLevelCalculatedMember=function(a){a=this.getHierarchy(a);a.cmembers={}};
...
function SaikuTableRenderer(a,b){this._data=a;this._options=_.extend({},SaikuRendererOptions,b)}function getAxisLevelsName(a,b){for(var c=a.query.queryModel.axes[b].hierarchies,d=c.length,e=[],f=0;f<d;f++)for(var h in c[f].levels)c[f].levels.hasOwnProperty(h)&&(Settings.COLUMN_TITLE_TABLE_USE_LEVEL_CAPTION_NAME?e.push(c[f].levels[h].caption):e.push(h));return e}function setStyleNegativeNumber(a){var b="";Settings.STYLE_NEGATIVE_NUMBER&&0>parseFloat(a)&&(b=" style_negative_number ");return b}
function getAxisSize(a,b){for(var c=a.query.queryModel.axes[b].hierarchies,d=c.length,e=0,f=0;f<d;f++)e+=_.size(c[f].levels);return e}
function getDomColumnsLevelsName(a){a=$(a.closest(".workspace").find(".workspace_fields").find(".columns.axis_fields").find(".hierarchy").find(".d_level"));var b=[];$.each(a,function(a,d){"display: list-item;"===$(d).attr("style")&&(Settings.COLUMN_TITLE_TABLE_USE_LEVEL_CAPTION_NAME?b.push($(d).find(".level").attr("title")):b.push($(d).find(".level").attr("level")))});return b}
SaikuTableRenderer.prototype.render=function(a,b){var c=this;a&&(this._data=a);b&&(this._options=_.extend({},SaikuRendererOptions,b));if("undefined"!=typeof this._data&&!(null!=this._data&&null!=this._data.error||null==this._data||this._data.cellset&&0===this._data.cellset.length))if(this.hideEmpty=this._options.hideEmpty,this._options.htmlObject)c._options.hasOwnProperty("batch")&&$(c._options.htmlObject).parent().parent().unbind("scroll"),_.defer(function(b){c._options.hasOwnProperty("batch")&&
!c._options.hasOwnProperty("batchSize")&&(c._options.batchSize=1E3);b=c.internalRender(c._data,c._options);$(c._options.htmlObject).html(b);$("#totals_summary").remove();$(c._options.htmlObject).after(c.renderSummary(a));_.defer(function(a){if(c._options.hasOwnProperty("batch")&&c._options.hasBatchResult){var b=0,d=!1,k=c._options.hasOwnProperty("batchIntervalSize")?c._options.batchIntervalSize:20;a=c._options.hasOwnProperty("batchIntervalTime")?c._options.batchIntervalTime:20;var l=c._options.batchResult.length,
g=_.debounce(function(){if(!d&&0<l&&b<l){d=!0;for(var a="",e=b,g=0;b<l&&g<k;g++,b++)a+=c._options.batchResult[b];b>e&&$(c._options.htmlObject).append($(a));d=!1}b>=l&&$(c._options.htmlObject).parent().parent().unbind("scroll")},a);$(c._options.htmlObject).parent().parent().scroll(function(){g()})}});return b});else return this.internalRender(this._data,c._options)};SaikuTableRenderer.prototype.clear=function(a,b){this._options&&this._options.htmlObject&&this._options.hasOwnProperty("batch")&&$(this._options.htmlObject).parent().parent().unbind("scroll")};
SaikuTableRenderer.prototype.processData=function(a,b){this._hasProcessed=!0};function genTotalDataCells(a,b,c,d,e){var f="";e=e[ROWS];for(var h=c.length-1;0<=h;h--)if(a==c[h]){for(var k=e[h][d[h]],l=0;l<k.cells.length;l++)f+='\x3ctd class\x3d"data total"\x3e'+k.cells[l][b].value+"\x3c/td\x3e";d[h]++;d[h]<e[h].length&&(c[h]+=e[h][d[h]].width)}return f}
function genTotalHeaderCells(a,b,c,d,e,f){for(var h="",k=b;0<=k;k--)if(a==c[k]){var l=e[k][d[k]],g;g=0==k&&1==b?"col":k==b?"col_total_corner":k==b-1&&l.captions?"col_total_first":"col_null";for(var m=0;m<l.cells.length;m++){var n="\x26nbsp;";b==e.length-1&&(l.captions&&(n=e[k][d[k]].captions[m]),0==k&&0==d[k]&&(n=l.captions?n+"\x26nbsp;":"",n+=f?"\x3cspan class\x3d'i18n'\x3eGrand Total\x3c/span\x3e":"Grand Total"));h+='\x3cth class\x3d"'+g+'"\x3e'+(f?"\x3cdiv\x3e"+n+"\x3c/div\x3e":n)+"\x3c/th\x3e"}d[k]++;
d[k]<e[k].length&&(c[k]+=e[k][d[k]].width)}return h}function totalIntersectionCells(a,b,c,d,e){for(var f="";0<=b;b--)if(a==c[b]){for(var h=e[b][d[b]],k=0;k<h.cells.length;k++)f+='\x3ctd class\x3d"data total"\x3e\x26nbsp;\x3c/td\x3e';d[b]++;d[b]<e[b].length&&(c[b]+=e[b][d[b]].width)}return f}
function isNextTotalsRow(a,b,c,d,e){d=d[COLUMNS];b=b[COLUMNS];c=c[COLUMNS];for(var f=e=d.length-2;0<=f;f--)if(a==b[f])for(var h=0;h<d[f][c[f]].cells.length;h++)for(var k=0;k<=e;k++)if((0!=f||0!=k)&&f==k+1)return k;return-1}
function genTotalHeaderRowCells(a,b,c,d,e){for(var f=d[COLUMNS],h=b[COLUMNS],k=c[COLUMNS],l=f.length-2,g="",m=l;0<=m;m--)if(a==h[m]){for(var n=0;n<f[m][k[m]].cells.length;n++){g+="\x3ctr\x3e";for(b=0;b<=l;b++){var s="\x26nbsp;";c=0==m&&0==b?"row":m==b+1?"row_total_corner":m==b&&f[m][k[m]].captions?"row_total_first":m<b+1?"row_total":"row_null";b==l&&(f[m][k[m]].captions&&(s=f[m][k[m]].captions[n]),0==m&&0==k[m]&&(s=f[m][k[m]].captions?s+"\x26nbsp;":"",s+=e?"\x3cspan class\x3d'i18n'\x3eGrand Total\x3c/span\x3e":
"Grand Total"));g+='\x3cth class\x3d"'+c+'"\x3e'+(e?"\x3cdiv\x3e"+s+"\x3c/div\x3e":s)+"\x3c/th\x3e"}c={};b={};if(d[ROWS])for(s=0;s<d[ROWS].length;s++)c[s]=0,b[s]=d[ROWS][s][c[s]].width;for(s=0;s<f[m][k[m]].cells[n].length;s++)g+='\x3ctd class\x3d"data total"\x3e'+f[m][k[m]].cells[n][s].value+"\x3c/td\x3e",d[ROWS]&&(g+=totalIntersectionCells(s+1,d[ROWS].length-1,b,c,d[ROWS]));g+="\x3c/tr\x3e"}k[m]++;k[m]<f[m].length&&(h[m]+=f[m][k[m]].width)}return g}var ROWS="ROWS",COLUMNS="COLUMNS";
...
function cleanupTotals(a,b){for(var c=0;c<a.length;c++){var d=a[c];if(b[d]){for(var e=!0,f=0;f<b[d].length;f++)for(var h=b[d][f],k=0;k<h.length;k++)for(var l=b[d][f][k].cells,g=0;g<l.length;g++)for(var m=l[g],n=0;n<m.length;n++)"-"!==m[n].value&&(e=!1);e&&(b[d]=null)}}}
SaikuTableRenderer.prototype.internalRender=function(a,b){var c="",d="",e=a.cellset,f="",h=[],k=[],l=e?e:[],g,m,n,s,p,B=0,r=[],C=null,E=!1,D=!1,H=!1,K=[],A=!0;b&&(C=b.hasOwnProperty("batchSize")?b.batchSize:null,A=b.hasOwnProperty("wrapContent")?b.wrapContent:!0);var w={};w[COLUMNS]=a.rowTotalsLists;w[ROWS]=a.colTotalsLists;var x={},I={},d=[ROWS,COLUMNS],M=a.query&&a.query.queryModel&&a.query.queryModel.details?a.query.queryModel.details.measures.length:0;if("object"===typeof this._options.htmlObject&&
Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0<M&&"QUERYMODEL"===a.query.type&&"COLUMNS"===a.query.queryModel.details.axis&&"BOTTOM"===a.query.queryModel.details.location)var N=getAxisLevelsName(a,COLUMNS),D=getDomColumnsLevelsName(this._options.htmlObject),T=getAxisSize(a,ROWS),P=0,N=N.length===D.length?D:_.intersection(D,N);for(var t=0;t<d.length;t++)x[d[t]]=[],I[d[t]]=[];cleanupTotals(d,w);if(w[COLUMNS])for(t=0;t<w[COLUMNS].length;t++)I[COLUMNS][t]=0,x[COLUMNS][t]=w[COLUMNS][t][I[COLUMNS][t]].width;
for(var v=0,Q=l.length;v<Q;v++){var O=v-a.topOffset;g=1;var R=D=s=m=!1;if(w[ROWS])for(t=0;t<w[ROWS].length;t++)I[ROWS][t]=0,x[ROWS][t]=w[ROWS][t][I[ROWS][t]].width;rowWithOnlyEmptyCells=!0;var d="\x3ctr\x3e",q=null;0===v&&(d="\x3cthead\x3e"+d);"object"===typeof this._options.htmlObject&&Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&0<M&&"QUERYMODEL"===a.query.type&&"COLUMNS"===a.query.queryModel.details.axis&&"BOTTOM"===a.query.queryModel.details.location&&P<N.length&&(d+='\x3cth class\x3d"row_header" style\x3d"text-align: right;" colspan\x3d"'+
T+'" title\x3d"'+N[P]+'"\x3e'+(A?"\x3cdiv\x3e"+N[P]+"\x3c/div\x3e":N[P])+"\x3c/th\x3e",P+=1);for(var u=0,S=l[v].length;u<S;u++)if(t=u-a.leftOffset,q=e[v][u],"COLUMN_HEADER"===q.type&&(D=!0),"COLUMN_HEADER"===q.type&&"null"===q.value&&(null==n||u<n)){if(!Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE||Settings.ALLOW_AXIS_COLUMN_TITLE_TABLE&&"BOTTOM"!==a.query.queryModel.details.location||0===M||"MDX"===a.query.type)d+='\x3cth class\x3d"all_null"\x3e\x26nbsp;\x3c/th\x3e'}else if("COLUMN_HEADER"===q.type){null==
n&&(n=u);l[v].length==u+1?s=!0:p=e[v][u+1];if(s)"null"==q.value?d+='\x3cth class\x3d"col_null"\x3e\x26nbsp;\x3c/th\x3e':(w[ROWS]&&(g=w[ROWS][v+1][I[ROWS][v+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+g+'" title\x3d"'+q.value+'"\x3e'+(A?'\x3cdiv rel\x3d"'+v+":"+u+'"\x3e'+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e");else{var t=1<u&&1<v&&!m&&u>n?e[v-1][u+1].value!=e[v-1][u].value||e[v-1][u+1].properties.uniquename!=e[v-1][u].properties.uniquename:!1,G=999<g?!0:
!1;q.value!=p.value||nextParentsDiffer(e,v,u)||m||t||G?("null"==q.value?d+='\x3cth class\x3d"col_null" colspan\x3d"'+g+'"\x3e\x26nbsp;\x3c/th\x3e':(w[ROWS]&&(g=w[ROWS][v+1][I[ROWS][v+1]].span),d+='\x3cth class\x3d"col" style\x3d"text-align: center;" colspan\x3d"'+(0==g?1:g)+'" title\x3d"'+q.value+'"\x3e'+(A?'\x3cdiv rel\x3d"'+v+":"+u+'"\x3e'+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e"),g=1):g++}w[ROWS]&&(d+=genTotalHeaderCells(u-a.leftOffset+1,v+1,x[ROWS],I[ROWS],w[ROWS],A))}else if("ROW_HEADER"===
q.type&&"null"===q.value)d+='\x3cth class\x3d"row_null"\x3e\x26nbsp;\x3c/th\x3e';else if("ROW_HEADER"===q.type){B==u?m=!0:p=e[v][u+1];var G=e[v-1],t=e[v+1],G=!R&&!m&&(0==u||!topParentsDiffer(e,v,u))&&q.value===G[u].value,R=!G,F=!1;if(Settings.ALLOW_TABLE_DATA_COLLAPSE)if(0<v&&v<Q-1){if(null==w[ROWS]||u<=S-w[ROWS].length-1){var y=!0;w[COLUMNS]&&0<=O&&u<=isNextTotalsRow(O+1,x,I,w,A)&&(F=!0,y=!1);if(y&&t[u].value==q.value)if(0<u)for(y=0;y<u;y++)if(t[y].value==e[v][y].value)F=!0;else{F=!1;break}else F=
!0}}else 0<v&&v==Q-1&&w[COLUMNS]&&0<=O&&u<=isNextTotalsRow(O+1,x,I,w,A)&&(F=!0);t=G?"\x3cdiv\x3e\x26nbsp;\x3c/div\x3e":'\x3cdiv rel\x3d"'+v+":"+u+'"\x3e'+(F&&Settings.ALLOW_TABLE_DATA_COLLAPSE?'\x3cspan class\x3d"expander expanded" style\x3d"cursor: pointer;"\x3e\x26#9660;\x3c/span\x3e':"")+q.value+"\x3c/div\x3e";A||(t=G?"\x26nbsp;":q.value);G=G?"row_null":"row";F=0;if(!m&&("undefined"==typeof p||"null"===p.value)){var F=1,y=q.properties.dimension,J=q.properties.level,y=y in r?r[y].length-r[y].indexOf(J):
1,J=u+1;for(;F<y&&J<=B+1&&"null"!==e[v][J];J++)F=J-u;u=u+F-1}d+='\x3cth class\x3d"'+G+'" '+(0<F?' colspan\x3d"'+F+'"':"")+"\x3e"+t+"\x3c/th\x3e"}else if("ROW_HEADER_HEADER"===q.type){G=[];if(_.contains(h,q.value)){for(t=0;t<h.length;t++)h[t]===q.value&&G.push(t);G.push(u)}d+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+q.value+"\x3c/div\x3e":q.value)+"\x3c/th\x3e";h.push(q.value);k.push({name:q.value,hierName:function(a){a=a.properties.hierarchy;return a.replace(/[\[\]]/gi,"").split(".")[1]?
a.replace(/[\[\]]/gi,"").split(".")[1]:a.replace(/[\[\]]/gi,"").split(".")[0]}(q)+"/"+q.value});m=!0;B=u;q.properties.hasOwnProperty("dimension")&&(y=q.properties.dimension,y in r||(r[y]=[]),r[y].push(q.properties.level));if(0<G.length){F=0;d="\x3ctr\x3e";0===v&&(d="\x3cthead\x3e"+d);for(t=0;t<k.length;t++)G[F]===t?(f+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+k[t].hierName+"\x3c/div\x3e":k[t].hierName)+"\x3c/th\x3e",F+=1):f+='\x3cth class\x3d"row_header"\x3e'+(A?"\x3cdiv\x3e"+k[t].name+
"\x3c/div\x3e":k[t].name)+"\x3c/th\x3e";d+=f}}else"DATA_CELL"===q.type&&(E=!0,G="",y=_.isEmpty(q.value)?Settings.EMPTY_VALUE_CHARACTER:q.value,F="",q.properties.hasOwnProperty("image")&&(y=q.properties.hasOwnProperty("image_height")?" height\x3d'"+q.properties.image_height+"'":"",J=q.properties.hasOwnProperty("image_width")?" width\x3d'"+q.properties.image_width+"'":"",y="\x3cimg "+y+" "+J+" style\x3d'padding-left: 5px' src\x3d'"+q.properties.image+"' border\x3d'0'\x3e"),"-"!==y&&""!==y&&q.properties.hasOwnProperty("style")&&
(G=" style\x3d'background-color: "+q.properties.style+"' "),q.properties.hasOwnProperty("link")&&(y="\x3ca target\x3d'__blank' href\x3d'"+q.properties.link+"'\x3e"+y+"\x3c/a\x3e"),q.properties.hasOwnProperty("arrow")&&(F="\x3cimg height\x3d'10' width\x3d'10' style\x3d'padding-left: 5px' src\x3d'./images/arrow-"+q.properties.arrow+".gif' border\x3d'0'\x3e"),"-"!==y&&""!==y&&(rowWithOnlyEmptyCells=!1),d+='\x3ctd class\x3d"data" '+G+"\x3e"+(A?'\x3cdiv class\x3d"datadiv '+setStyleNegativeNumber(q.properties.raw)+
'" alt\x3d"'+q.properties.raw+'" rel\x3d"'+q.properties.position+'"\x3e':"")+y+F+(A?"\x3c/div\x3e":"")+"\x3c/td\x3e",w[ROWS]&&(d+=genTotalDataCells(t+1,O,x[ROWS],I[ROWS],w,A)));d+="\x3c/tr\x3e";b.hideEmpty&&"DATA_CELL"===q.type&&rowWithOnlyEmptyCells&&(d="");g="";w[COLUMNS]&&0<=O&&(g+=genTotalHeaderRowCells(O+1,x,I,w,A));E&&C?v<=C?(D||H||(c+="\x3c/thead\x3e\x3ctbody\x3e",H=!0),c+=d,0<g.length&&(c+=g)):(K.push(d),0<g.length&&K.push(g)):(D||H||(c+="\x3c/thead\x3e\x3ctbody\x3e",H=!0),c+=d,0<g.length&&
(c+=g))}b&&(b.batchResult=K,b.hasBatchResult=0<K.length);return"\x3ctable\x3e"+c+"\x3c/tbody\x3e\x3c/table\x3e"};
SaikuTableRenderer.prototype.renderSummary=function(a){if(a&&a.query){var b=!1;a=a.query.queryModel.details?a.query.queryModel.details.measures:[];for(var c={},d=0;d<a.length;d++){var e=a[d];if(e.aggregators)for(var f=0;f<e.aggregators.length;f++){var h=e.aggregators[f];if(0<h.indexOf("_")){var k=h.split("_"),h=k[0],k=k[1];"nil"!==h&&"not"!==h&&(b=!0,h=h.capitalizeFirstLetter(),k in c||(c[k]=[]),c[k].push(e.name+": "+h))}}}if(b){var l="\x3cdiv id\x3d'totals_summary'\x3e\x3cbr/\x3e";$.each(c,function(a,
b){l+="\x3ch3\x3e"+a.capitalizeFirstLetter();for(var c=0;c<b.length;c++)l+="\x3cbr/\x3e\x26nbsp;"+b[c];l+="\x3c/h3\x3e"});return l+"\x3c/div\x3e"}}return""};String.prototype.capitalizeFirstLetter=function(){return this.charAt(0).toUpperCase()+this.slice(1).toLowerCase()};
var SaikuChartRenderer=function(a,b){this.workspace=b.workspace;this.rawdata=a;this.cccOptions={};this.data=null;this.hasRendered=this.hasProcessed=!1;if(!b&&!b.hasOwnProperty("htmlObject"))throw"You need to supply a html object in the options for the SaikuChartRenderer!";this.el=$(b.htmlObject);this.id=_.uniqueId("chart_");$(this.el).html('\x3cdiv class\x3d"canvas_wrapper" style\x3d"display:none;"\x3e\x3cdiv id\x3d"canvas_'+this.id+'"\x3e\x3c/div\x3e\x3c/div\x3e');if(this.zoom=b.zoom){var c=this;
$("\x3cspan style\x3d'float:left;' class\x3d'zoombuttons'\x3e\x3ca href\x3d'#' class\x3d'button rerender i18n' title\x3d'Re-render chart'\x3e\x3c/a\x3e\x3ca href\x3d'#' class\x3d'button zoomout i18n' style\x3d'display:none;' title\x3d'Zoom back out'\x3e\x3c/a\x3e\x3c/span\x3e").prependTo($(this.el).find(".canvas_wrapper"));$(this.el).find(".zoomout").on("click",function(a){a.preventDefault();c.zoomout()});$(this.el).find(".zoomin").on("click",function(a){a.preventDefault();c.zoomin()});$(this.el).find(".rerender").on("click",
function(a){a.preventDefault();$(c.el).find(".zoomout").hide();c.switch_chart(c.type)})}b.chartDefinition&&(this.chartDefinition=b.chartDefinition);this.cccOptions.canvas="canvas_"+this.id;this.adjustSizeTo=this.data=null;this.adjustSizeTo=b.adjustSizeTo?b.adjustSizeTo:b.htmlObject;this.rawdata&&("sunburst"==this.type?this.process_data_tree({data:this.rawdata}):this.process_data_tree({data:this.rawdata},!0,!0));b.mode?this.switch_chart(b.mode):this.switch_chart("stackedBar");this.adjust()};
SaikuChartRenderer.prototype.adjust=function(){var a=this,b=_.debounce(function(){a.hasRendered&&$(a.el).is(":visible")&&a.switch_chart(a.type)},300);$(window).resize(function(){$(a.el).find(".canvas_wrapper").fadeOut(150);b()})};SaikuChartRenderer.prototype.zoomin=function(){$(this.el).find(".canvas_wrapper").hide();var a=this.chart.root,b=a.data;b.datums(null,{selected:!1}).each(function(a){a.setVisible(!1)});b.clearSelected();a.render(!0,!0,!1);this.render_chart_element()};
...
SaikuChartRenderer.prototype.switch_chart=function(a,b){if(!(null==b&&void 0==b||null==b.chartDefinition&&void 0==b.chartDefinition)){this.chartDefinition=b.chartDefinition;void 0!=b.chartDefinition.type&&(this.type=b.chartDefinition.type);if(null!=b.workspace||void 0!=b.workspace)this.workspace=b.workspace;void 0!=b.hasProcessed&&(this.hasProcessed=b.hasProcessed)}var c={stackedBar:{type:"BarChart",stacked:!0},bar:{type:"BarChart"},multiplebar:{type:"BarChart",multiChartIndexes:[1],dataMeasuresInColumns:!0,
orientation:"vertical",smallTitlePosition:"top",multiChartMax:30,multiChartColumnsMax:Math.floor(this.cccOptions.width/200),smallWidth:200,smallHeight:150},line:{type:"LineChart"},pie:{type:"PieChart",multiChartIndexes:[0]},heatgrid:{type:"HeatGridChart"},stackedBar100:{type:"NormalizedBarChart"},area:{type:"StackedAreaChart"},dot:{type:"DotChart"},waterfall:{type:"WaterfallChart"},treemap:{type:"TreemapChart"},sunburst:{type:"SunburstChart"},multiplesunburst:{type:"SunburstChart",multiChartIndexes:[1],
dataMeasuresInColumns:!0,orientation:"vertical",smallTitlePosition:"top",multiChartMax:30,multiChartColumnsMax:Math.floor(this.cccOptions.width/200),smallWidth:200,smallHeight:150,seriesInRows:!1},radar:{type:"RadarChart"},timewheel:{type:"TimeWheel"}};if(null!==a&&""!==a)if("sunburst"==a){$(this.el).find(".zoombuttons a").hide();this.type=a;var d=c[a];this.sunburst(d);this.hasProcessed&&this.render()}else"radar"==a?(this.type=a,this.drawRadarChart(d)):c.hasOwnProperty(a)?($(this.el).find(".zoombuttons a").hide(),
this.type=a,d=c[a],this.cccOptions=this.getQuickOptions(d),void 0!=this.chartDefinition&&(this.chartDefinition.type=d.type),this.define_chart(),this.hasProcessed&&this.render()):"charteditor"!==a&&alert("Do not support chart type: '"+a+"'")};
...
TimeWheel:{smallTitleFont:"bold 14px sans-serif",valuesVisible:!0,valuesMask:"{category} / {value.percent}",explodedSliceRadius:"10%",colors:"#1f77b4 #aec7e8 #ff7f0e #ffbb78 #2ca02c #98df8a #d62728 #ff9896 #9467bd #c5b0d5 #8c564b #c49c94 #e377c2 #f7b6d2 #7f7f7f #c7c7c7 #bcbd22 #dbdb8d #17becf #9edae5".split(" "),extensionPoints:{slice_offsetRadius:function(a){return a.isSelected()?"2%":0}},clickable:!1,plots:[]},LineChart:{extensionPoints:{area_interpolate:"monotone",line_interpolate:"monotone"}},
StackedAreaChart:{extensionPoints:{area_interpolate:"monotone",line_interpolate:"monotone"}},TreemapChart:{legendPosition:"right",multiChartIndexes:0,extensionPoints:{leaf_lineWidth:2},layoutMode:"slice-and-dice",valuesVisible:!0},SunburstChart:{valuesVisible:!1,hoverable:!1,selectable:!0,clickable:!1,multiChartIndexes:[0],multiChartMax:30}};
...
[];e.keptVisibleDatumSet.push(a)}else{f=0<e.keptVisibleDatumSet.length?e.keptVisibleDatumSet[e.keptVisibleDatumSet.length-1]:[];d=d.datums(null,{visible:!0}).array();d.length<f.length&&e.keptVisibleDatumSet.push(d);var h=[];_.each(_.difference(d,a),function(a){a.setVisible(!1)});_.each(_.intersection(d,a),function(a){h.push(a)});0<h.length&&e.keptVisibleDatumSet.push(h)}c.render(!0,!0,!1);return[]}};c=_.extend(c,{hoverable:d,animate:!1},this.chartDefinition);b.zoom&&(d=c.legend,c=_.extend(c,a),!1===
d&&(c.legend=!1));"TreemapChart"==c.type&&c.legend&&(c.legend.scenes.item.labelText=function(){var a="",b=this.group;if(b)switch(b=b.depth,b){case 0:return"";case 1:break;case 2:a=" └ ";break;default:a=Array(2*(b-2)+1).join(" ")+" └ "}return a+this.base()});if("TimeWheel"===c.type){console.log(this.data);d=0;a={};for(e=0;e<this.data.resultset.length;e++)a[this.data.resultset[e][0]]=!0;a=Object.keys(a);var d=a.length,f=1/d,h=1-f,k=1;c.plots=[];c.dimensions={};for(e=0;e<this.data.metadata.length;e++)c.dimensions[this.data.metadata[e].colName]=
{isHidden:!1};for(e=0;e<d;e++){var l=k;c.plots.push({name:0===e?"main":"plot_"+e,type:"pie",dataPart:a[e],valuesLabelStyle:"inside",valuesOptimizeLegibility:!0,valuesFont:'normal 10px "Open Sans"',slice_strokeStyle:"white",slice_innerRadiusEx:(100*h).toFixed(0)+"%",slice_outerRadius:function(){return l*this.delegate()}});h-=f;k-=f}2<this.data.metadata.length&&(c.readers=this.data.metadata[0].colName+", "+this.data.metadata[1].colName+", "+this.data.metadata[2].colName,c.visualRoles={dataPart:this.data.metadata[0].colName,
category:this.data.metadata[1].colName,value:this.data.metadata[2].colName});this.chart=new pvc.PieChart(c);this.chart.setData(this.data,{crosstabMode:!1})}else this.chart=new pvc[c.type](c),this.chart.setData(this.data,{crosstabMode:!0,seriesInRows:!1})};
...
SaikuChartRenderer.prototype.process_data_tree=function(a,b,c){var d={};b&&(d.resultset=[],d.metadata=[],d.height=0,d.width=0);var e=d;if("undefined"!=typeof a&&"undefined"!=typeof a.data&&!(null!==a.data&&null!==a.data.error||null===a.data||a.data.cellset&&0===a.data.cellset.length)){var f=a.data.cellset;if(f&&0<f.length){var h=0,k=0,l=!1,g,m,n,s=function(a,b){return a+b};g=0;for(m=f.length;0===k&&g<m;g++)for(var p=0,B=f[g].length;p<B;p++){if(!l)for(;"COLUMN_HEADER"==f[g][p].type&&"null"==f[g][p].value;)g++;
l=!0;if("ROW_HEADER_HEADER"==f[g][p].type){for(;"ROW_HEADER_HEADER"==f[g][p].type;)b&&d.metadata.push({colIndex:p,colType:"String",colName:f[g][p].value}),p++;h=p-1}if("COLUMN_HEADER"==f[g][p].type){k=0;for(n=[];k<=g;)"null"!==f[k][p].value&&n.push(f[k][p].value),k++;b&&d.metadata.push({colIndex:p,colType:"Numeric",colName:n.join(" ~ ")});k=g+1}}l=[];for(n=0;n<=h;n++)l.push(null);g=k;for(m=f.length;g<m;g++)if(""!==f[g][0].value){B=[];n=[];p=k=null;for(n=0;n<=h;n++){if(f[g]&&"null"===f[g][n].value){for(var e=
d,r=0;r<h&&"null"===f[g][r].value;r++)e=e[l[r]];r>n&&(n=r)}if(f[g]&&"null"!==f[g][n].value){if(0===n)for(r=0;r<=h;r++)l[r]=null;"number"==typeof e&&(k[p]={},e=k[p]);p=f[g][n].value;l[n]=p;e.hasOwnProperty(p)||(e[p]={});k=e;e=e[p]}}n=_.clone(l);e=h+1;for(r=f[g].length;e<r;e++){var C=f[g][e],E=C.value||0,D=0!==E,H=C.properties.raw;H&&"null"!==H?E=parseFloat(H):"number"!==typeof C.value&&parseFloat(C.value.replace(/[^a-zA-Z 0-9.]+/g,""))&&(E=parseFloat(C.value.replace(/[^a-zA-Z 0-9.]+/g,"")),D=!1);0<
E&&D&&(E=C.value&&0<=C.value.indexOf("%")?100*E:E);B.push(E);n.push({f:C.value,v:E})}b&&d.resultset.push(n);e=_.reduce(B,s,0);p=null===p?"null":p;k[p]=e;e=d}c&&(this.rawdata=a.data,this.data=d,this.hasProcessed=!0,this.data.height=this.data.resultset.length);return d}$(this.el).find(".canvas_wrapper").text("No results").show()}};
SaikuChartRenderer.prototype.drawRadarChart=function(a){var b={draw:function(a,b,f,h){function k(a,b){var c=(k.canvas||(k.canvas=document.createElement("canvas"))).getContext("2d");c.font=b;return c.measureText(a)}var g={radius:5,w:f.w||320,h:f.h||240,factor:1,factorLegend:.85,levels:3,maxValue:0,radians:2*Math.PI,opacityArea:.5,ToRight:5,TranslateX:0,TranslateY:30,ExtraWidthX:0,ExtraWidthY:65,color:d3.scale.category10()};if("undefined"!==typeof f)for(var l in f)"undefined"!==typeof f[l]&&(g[l]=f[l]);
g.maxValue=Math.max(g.maxValue,d3.max(b,function(a){return d3.max(a.map(function(a){return a.value}))}));f=b[0].map(function(a,b){return a.axis});var m=f.length;l=g.factor*Math.min(g.w/2,g.h/2);d3.select(a).select("svg").remove();var n=d3.select(a).append("svg").attr("width",g.w+g.ExtraWidthX).attr("height",g.h+g.ExtraWidthY).append("g").attr("transform","translate("+g.TranslateX+","+g.TranslateY+")"),w;for(a=0;a<g.levels-1;a++){var x=(a+1)/g.levels*l*g.factor;n.selectAll(".levels").data(f).enter().append("svg:line").attr("x1",
function(a,b){return x*(1-g.factor*Math.sin(b*g.radians/m))}).attr("y1",function(a,b){return x*(1-g.factor*Math.cos(b*g.radians/m))}).attr("x2",function(a,b){return x*(1-g.factor*Math.sin((b+1)*g.radians/m))}).attr("y2",function(a,b){return x*(1-g.factor*Math.cos((b+1)*g.radians/m))}).attr("class","line").style("stroke","grey").style("stroke-opacity","0.75").style("stroke-width","0.3px").attr("transform","translate("+(g.w/2-x)+", "+(g.h/2-x)+")")}for(a=0;a<g.levels;a++)x=(a+1)/g.levels*l*g.factor,
n.selectAll(".levels").data([1]).enter().append("svg:text").attr("x",function(a){return x*(1-g.factor*Math.sin(0))}).attr("y",function(a){return x*(1-g.factor*Math.cos(0))}).attr("class","legend").style("font-family","sans-serif").style("font-size","10px").attr("transform","translate("+(g.w/2-x+g.ToRight)+", "+(g.h/2-x)+")").attr("fill","#737373").text((a+1)*g.maxValue/g.levels);series=0;a=n.selectAll(".axis").data(f).enter().append("g").attr("class","axis");a.append("line").attr("x1",g.w/2).attr("y1",
g.h/2).attr("x2",function(a,b){return g.w/2*(1-g.factor*Math.sin(b*g.radians/m))}).attr("y2",function(a,b){return g.h/2*(1-g.factor*Math.cos(b*g.radians/m))}).attr("class","line").style("stroke","grey").style("stroke-width","1px");a.append("text").attr("class","legend").text(function(a){return a}).style("font-family","sans-serif").style("font-size","10px").attr("text-anchor","start").attr("dy","1.5em").attr("transform",function(a,b){return"translate(0, -10)"}).attr("x",function(a,b){var c=g.w/2*(1-
g.factorLegend*Math.sin(b*g.radians/m))-60*Math.sin(b*g.radians/m),d=k(a,"10px sans-serif").width,c=c-d/2;0>c&&(c=0);c+d>g.w&&(c=g.w-d);return c}).attr("y",function(a,b){return g.h/2*(1-Math.cos(b*g.radians/m))-20*Math.cos(b*g.radians/m)});b.forEach(function(a,b){dataValues=[];n.selectAll(".nodes").data(a,function(a,b){dataValues.push([g.w/2*(1-parseFloat(Math.max(a.value,0))/g.maxValue*g.factor*Math.sin(b*g.radians/m)),g.h/2*(1-parseFloat(Math.max(a.value,0))/g.maxValue*g.factor*Math.cos(b*g.radians/
m))])});dataValues.push(dataValues[0]);n.selectAll(".area").data([dataValues]).enter().append("polygon").attr("class","radar-chart-serie"+series).style("stroke-width","2px").style("stroke",g.color(series)).attr("points",function(a){for(var b="",c=0;c<a.length;c++)b=b+a[c][0]+","+a[c][1]+" ";return b}).style("fill",function(a,b){return g.color(series)}).style("fill-opacity",g.opacityArea).on("mouseover",function(a){z="polygon."+d3.select(this).attr("class");n.selectAll("polygon").transition(200).style("fill-opacity",
.1);n.selectAll(z).transition(200).style("fill-opacity",.7)}).on("mouseout",function(){n.selectAll("polygon").transition(200).style("fill-opacity",g.opacityArea)});series++});series=0;b.forEach(function(a,b){n.selectAll(".nodes").data(a).enter().append("svg:circle").attr("class","radar-chart-serie"+series).attr("r",g.radius).attr("alt",function(a){return Math.max(a.value,0)}).attr("cx",function(a,b){dataValues.push([g.w/2*(1-parseFloat(Math.max(a.value,0))/g.maxValue*g.factor*Math.sin(b*g.radians/
m)),g.h/2*(1-parseFloat(Math.max(a.value,0))/g.maxValue*g.factor*Math.cos(b*g.radians/m))]);return g.w/2*(1-Math.max(a.value,0)/g.maxValue*g.factor*Math.sin(b*g.radians/m))}).attr("cy",function(a,b){return g.h/2*(1-Math.max(a.value,0)/g.maxValue*g.factor*Math.cos(b*g.radians/m))}).attr("data-id",function(a){return a.axis}).style("fill",g.color(series)).style("fill-opacity",.9).on("mouseover",function(a){newX=parseFloat(d3.select(this).attr("cx"))-10;newY=parseFloat(d3.select(this).attr("cy"))-5;w.attr("x",
newX).attr("y",newY).text(a.value).transition(200).style("opacity",1);z="polygon."+d3.select(this).attr("class");n.selectAll("polygon").transition(200).style("fill-opacity",.1);n.selectAll(z).transition(200).style("fill-opacity",.7)}).on("mouseout",function(){w.transition(200).style("opacity",0);n.selectAll("polygon").transition(200).style("fill-opacity",g.opacityArea)}).append("svg:title").text(function(a){return Math.max(a.value,0)});series++});w=n.append("text").style("opacity",0).style("font-family",
"sans-serif").style("font-size","13px");b=d3.select(s).selectAll("svg").append("svg").attr("width",c).attr("height",d).append("g").attr("class","legend").attr("height",c).attr("width",d);b.selectAll("rect").data(h).enter().append("rect").attr("x",5).attr("y",function(a,b){return 20*b}).attr("width",10).attr("height",10).style("fill",function(a,b){return e(b)});b.selectAll("text").data(h).enter().append("text").attr("x",20).attr("y",function(a,b){return 20*b+9}).attr("font-size","10px").attr("fill",
"#737373").text(function(a){return a})}};a=this.getQuickOptions(a);var c=a.width,d=a.height,e=d3.scale.category10(),f=[],h=[];a=[];for(var k=[],l=0;l<this.data.metadata.length;l++)"String"===this.data.metadata[l].colType?a.push(l):k.push(l);for(l=0;l<this.data.resultset.length;l++){h[l]=[];for(var g=[],m=0;m<a.length;m++)g.push(this.data.resultset[l][m]);f.push(g.join(" "));for(m=0;m<k.length;m++)g=k[m],h[l].push({axis:this.data.metadata[g].colName,value:this.data.resultset[l][g].v})}var n={w:c,h:d,
maxValue:.6,levels:6,ExtraWidthX:0},s="#"+this.cccOptions.canvas;$(s).html("");b.draw(s,h,n,f);this.chart={render:function(){b.draw(s,h,n,f)}};this.render()};
var DataSources=Backbone.Model.extend({url:"admin/attacheddatasources",initialize:function(a,b){b&&b.dialog&&(this.dialog=b.dialog)},parse:function(a){if(this.dialog&&this.dialog.callback)this.dialog.callback(a);else return a}}),Cube=Backbone.Model.extend({initialize:function(a){this.url=Saiku.session.username+"/discover/"+a.key+"/metadata"},parse:function(a){var b=_.template($("#template-dimensions").html(),{dimensions:a.dimensions}),c=_.template($("#template-measures").html(),{measures:a.measures}),
d=_.template($("#template-attributes").html(),{cube:a});this.set({template_measures:c,template_dimensions:b,template_attributes:$(d).html(),data:a});"undefined"!==typeof localStorage&&localStorage&&localStorage.setItem("cube."+this.get("key"),JSON.stringify(this).replace(/ {3}/g,""));return a}}),DimensionList=Backbone.View.extend({events:{"click span":"select","click a":"select","click .parent_dimension ul li a.level":"select_dimension","click .measure":"select_measure","click .addMeasure":"measure_dialog"},
...
call:function(a){}}),Modal=Backbone.View.extend({tagName:"div",className:"dialog",type:"modal",message:"Put content here",options:{autoOpen:!1,modal:!0,title:"Modal dialog",resizable:!1,draggable:!0,close:function(a,b){_.defer(function(){$(a.target).closest(".ui-dialog").remove()})}},events:{"click a":"call"},buttons:[{text:"OK",method:"close"}],template:function(){return _.template('\x3cdiv class\x3d"dialog_icon"\x3e\x3c/div\x3e\x3cdiv class\x3d"dialog_body"\x3e\x3c%\x3d message %\x3e\x3c/div\x3e\x3cdiv class\x3d"dialog_footer"\x3e\x3c% _.each(buttons, function(button) { %\x3e\x3ca class\x3d"form_button btn btn-default i18n" href\x3d"#\x3c%\x3d button.method %\x3e"\x3e\x26nbsp;\x3c%\x3d button.text %\x3e\x26nbsp;\x3c/a\x3e\x3c% }); %\x3e\x3cdiv class\x3d"dialog_response"\x3e\x3c/div\x3e\x3c/div\x3e')(this)},
...
"click .clear_search":"clear_search","change #show_unique":"show_unique_action","change #use_result":"use_result_action","dblclick .selection_options li.option_value label":"click_move_selection","click li.all_options":"click_all_member_selection","change #per_metrics_totals_checkbox":"per_metrics_totals_action"},show_unique_option:!1,per_metrics_totals:!1,use_result_option:Settings.MEMBERS_FROM_RESULT,show_totals_option:[],members_limit:Settings.MEMBERS_LIMIT,members_search_limit:Settings.MEMBERS_SEARCH_LIMIT,
members_search_server:!1,selection_type:"INCLUSION",initialize:function(a){_.extend(this,a);this.options.title="\x3cspan class\x3d'i18n'\x3eSelections for\x3c/span\x3e "+this.name;this.message="Fetching members...";this.query=a.workspace.query;this.selected_members=[];this.available_members=[];this.topLevel;_.bindAll(this,"fetch_members","populate","finished","get_members","use_result_action","per_metrics_totals_action");this.axis="undefined";a.axis?(this.axis=a.axis,"FILTER"==a.axis&&(this.use_result_option=
!1)):(a.target.parents(".fields_list_body").hasClass("rows")&&(this.axis="ROWS"),a.target.parents(".fields_list_body").hasClass("columns")&&(this.axis="COLUMNS"),a.target.parents(".fields_list_body").hasClass("filter")&&(this.axis="FILTER",this.use_result_option=!1));this.bind("open",this.post_render);this.render();$(this.el).parent().find(".ui-dialog-titlebar-close").bind("click",this.finished);this.member=new Member({},{cube:a.workspace.selected_cube,dimension:a.key});$(this.el).find(".dialog_body").html(_.template($("#template-selections").html())(this));
...
void 0!=this.query.helper.model().parameters[b]&&(this.paramvalue=this.query.helper.model().parameters[b].split(","))),$(this.el).find(".parameter").removeClass("hidden"));this.init_totals(a,c);$(this.el).find("#use_result").attr("checked",this.use_result_option);$(this.el).find(".search_limit").text(this.members_search_limit);$(this.el).find(".members_limit").text(this.members_limit);0<this.workspace.query.helper.getCalculatedMembers().length?this.fetch_calcmembers_levels():this.get_members()},init_totals:function(a,
b){for(var c=this,d=c.workspace.query.model.queryModel.details.measures,e=0;e<d.length;e++)$(this.el).find("#div-totals-container").append(_.template($("#template-selections-totals").html())({measure:d[e]}));1<_.size(a.levels)&&b&&b.hasOwnProperty("aggregators")&&b.aggregators&&0<b.aggregators.length?(this.show_totals_option=b.aggregators,1<_.uniq(this.show_totals_option).length&&this.per_metrics_totals_action()):this.show_totals_option=[];0<this.show_totals_option.length&&(this.per_metrics_totals?
$(this.el).find(".show_totals_select").each(function(a){"undefined"!==typeof c.show_totals_option[a]&&$(this).val(c.show_totals_option[a])}):$(this.el).find("#all_measures_select").val(c.show_totals_option[0]));$(this.el).find("#per_metrics_totals_checkbox").attr("checked",this.per_metrics_totals)},open_date_filter:function(a){a.preventDefault();(new DateFilterModal({dimension:this.objDateFilter.dimension,hierarchy:this.objDateFilter.hierarchy,target:this.target,name:this.name,data:this.objDateFilter.data,
analyzerDateFormat:this.objDateFilter.analyzerDateFormat,dimHier:this.objDateFilter.dimHier,key:this.key,workspace:this.workspace})).open();this.$el.dialog("destroy").remove()},per_metrics_totals_action:function(a){this.per_metrics_totals=!this.per_metrics_totals;!0===this.per_metrics_totals?($(this.el).find(".per_metrics_container").show(),$(this.el).find(".all_metrics_container").hide()):($(this.el).find(".per_metrics_container").hide(),$(this.el).find(".all_metrics_container").show())},get_members:function(){var a=
this,b="/result/metadata/hierarchies/"+encodeURIComponent(this.member.hierarchy)+"/levels/"+encodeURIComponent(this.member.level);this.search_path=b;a.workspace.block('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3e'+a.message+"\x3c/span\x3e ");this.workspace.query.action.gett(b,{success:this.fetch_members,error:function(){a.workspace.unblock()},data:{result:this.use_result_option,searchlimit:this.members_limit}})},clear_search:function(){$(this.el).find(".filterbox").val("");
this.available_members=[];this.get_members()},search_members:function(){var a=this,b=$(this.el).find(".filterbox").val();if(!b)return!1;a.workspace.block('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3eSearching for members matching:\x3c/span\x3e '+b);a.workspace.query.action.gett(a.search_path,{async:!1,success:function(b,d){d&&0<d.length&&(a.available_members=d);a.populate()},error:function(){a.workspace.unblock()},data:{search:b,searchlimit:a.members_search_limit}})},
fetch_calcmembers_levels:function(){var a=this.member.hierarchy.split("].["),b=!0;1===a.length&&(b=!1,a=this.member.hierarchy.split("."));if(1<a.length)var c=a[1].replace(/[\[\]]/gi,"");a=a[0].replace(/[\[\]]/gi,"");this.workspace.block('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3e'+this.message+"\x3c/span\x3e ");b||(c=void 0!=c?a+"."+c:a);(new Level({},{ui:this,cube:this.workspace.selected_cube,dimension:a,hierarchy:c})).fetch({success:this.get_levels})},
get_levels:function(a,b){b&&0<b.length&&(a.ui.topLevel=b[0],a.ui.get_members())},get_calcmembers:function(){var a=this,b=this.member.hierarchy,c=this.workspace.query.helper.getCalculatedMembers(),d=[];this.topLevel.name===this.member.level?_.filter(c,function(a){a.hierarchyName===b&&_.isEmpty(a.parentMember)&&(a.uniqueName=a.hierarchyName+".["+a.name+"]",d.push(a))}):_.filter(c,function(c){c.hierarchyName===b&&c.parentMemberLevel===a.member.level&&(c.uniqueName=c.parentMember+".["+c.name+"]",d.push(c))});
return d},fetch_members:function(a,b){var c=this;b&&0<b.length&&_.each(b,function(a){var b=c.workspace.query.helper.getCalculatedMembers(),f=!1;b&&0<b.length&&_.each(b,function(b){b.uniqueName===a.uniqueName&&(f=!0)});c.available_members.push({obj:a,calc:f})});this.populate()},populate:function(a,b){var c=this;c.workspace.unblock();this.members_search_server=this.available_members.length>=this.members_limit||0==this.available_members.length;c.show_unique_option=!1;$(this.el).find(".options #show_unique").attr("checked",
!1);var d=this.workspace.query.helper.getCalculatedMembers();if(0<d.length)for(var e=this.get_calcmembers(),f=e.length,h=0;h<f;h++){var k=!1;d&&0<d.length&&_.each(d,function(a){a.uniqueName===e[h].uniqueName&&(k=!0)});this.available_members.push({obj:e[h],calc:k})}$(this.el).find(".items_size").text(this.available_members.length);this.members_search_server?$(this.el).find(".warning").text("More items available than listed. Pre-Filter on server."):$(this.el).find(".warning").text("");f=c.member.level;
(d=c.workspace.query.helper.getHierarchy(c.member.hierarchy))&&d.levels.hasOwnProperty(f)&&(this.selected_members=[],d.levels[f].selection&&_.each(d.levels[f].selection.members,function(a){var b=c.workspace.query.helper.getCalculatedMembers(),d=!1;b&&0<b.length&&_.each(b,function(b){b.uniqueName===a.uniqueName&&(d=!0)});c.selected_members.push({obj:a,calc:d})}),this.selection_type=d.levels[f].selection?d.levels[f].selection.type:"INCLUSION");for(var l=[],d=0,f=this.selected_members.length;d<f;d++)l.push(this.selected_members[d].obj.caption);
0==$(this.el).find(".used_selections .selection_options li.option_value").length&&(d=$(this.el).find(".used_selections .selection_options"),d.empty(),f=_.template($("#template-selections-options").html())({options:this.selected_members}),$(d).html(f));this.available_members=_.select(this.available_members,function(a){return-1===l.indexOf(a.obj?a.obj.caption:a.caption)});0<this.available_members.length&&(d=$(this.el).find(".available_selections .selection_options"),d.empty(),f=_.template($("#template-selections-options").html())({options:this.available_members}),
$(d).html(f));0<$(c.el).find(".selection_options.ui-selectable").length&&$(c.el).find(".selection_options").selectable("destroy");$(c.el).find(".selection_options").selectable({distance:20,filter:"li",stop:function(a,b){$(c.el).find(".selection_options li.ui-selected input").each(function(a,b){b&&b.hasAttribute("checked")?b.checked=!0:$(b).attr("checked",!0);$(b).parents(".selection_options").find("li.all_options input").prop("checked",!0)});$(c.el).find(".selection_options li.ui-selected").removeClass("ui-selected")}});
$(this.el).find(".filterbox").autocomplete({minLength:1,delay:200,appendTo:".autocomplete",source:function(a,b){var d=0==c.show_unique_option?"caption":"name",e=$.map(c.available_members,function(b){var e=b.obj;void 0===e?(e=b,b=e[d]):b=e.caption;if(-1<b.toLowerCase().indexOf(a.term.toLowerCase()))return{label:0==c.show_unique_option?e.caption:e.uniqueName,value:0==c.show_unique_option?e.uniqueName:e.caption}});b(e)},select:function(a,b){encodeURIComponent(b.item.value);var d=b.item.label,e=0==c.show_unique_option?
b.item.value:b.item.label,f=0==c.show_unique_option?b.item.label:b.item.value;$(c.el).find('.available_selections .selection_options input[value\x3d"'+encodeURIComponent(e)+'"]').parent().remove();$(c.el).find('.used_selections .selection_options input[value\x3d"'+encodeURIComponent(e)+'"]').parent().remove();d='\x3cli class\x3d"option_value"\x3e\x3cinput type\x3d"checkbox" class\x3d"check_option" value\x3d"'+encodeURIComponent(e)+'" label\x3d"'+encodeURIComponent(f)+'"\x3e'+d+"\x3c/input\x3e\x3c/li\x3e";
$(d).appendTo($(c.el).find(".used_selections .selection_options ul"));$(c.el).find(".filterbox").val("");b.item.value=""},close:function(a,b){},open:function(a,b){}});$(this.el).find(".filterbox").autocomplete("enable");"EXCLUSION"===this.selection_type?($(this.el).find(".selection_type_inclusion").prop("checked",!1),$(this.el).find(".selection_type_exclusion").prop("checked",!0)):($(this.el).find(".selection_type_inclusion").prop("checked",!0),$(this.el).find(".selection_type_exclusion").prop("checked",
!1));Saiku.i18n.translate();Saiku.ui.unblock()},post_render:function(a){var b=($(window).width()-1E3)/2,c=1040>$(window).width()?$(window).width():1040;$(a.modal.el).parents(".ui-dialog").css({width:c,left:"inherit",margin:"0",height:630}).offset({left:b});$("#filter_selections").attr("disabled",!1);$(this.el).find("a[href\x3d#save]").focus();$(this.el).find("a[href\x3d#save]").blur()},move_selection:function(a){a.preventDefault();a=$(a.target).attr("id");var b=-1!==a.indexOf("add")?$(this.el).find(".used_selections .selection_options ul"):
$(this.el).find(".available_selections .selection_options ul"),c=-1!==a.indexOf("add")?$(this.el).find(".available_selections .selection_options ul"):$(this.el).find(".used_selections .selection_options ul");(-1!==a.indexOf("all")?c.find("li.option_value input").parent():c.find("li.option_value input:checked").parent()).detach().appendTo(b);$(this.el).find(".selection_options ul li.option_value input:checked").prop("checked",!1);$(this.el).find(".selection_options li.all_options input").prop("checked",
!1)},updown_selection:function(a){a.preventDefault();return!1},click_all_member_selection:function(a,b){$(a.currentTarget).find("input").is(":checked")?$(a.currentTarget).parent().find("li.option_value input").prop("checked",!0):$(a.currentTarget).parent().find("li.option_value input").removeAttr("checked")},click_move_selection:function(a,b){a.preventDefault();var c=$(a.target).parent().parent().parent().parent().hasClass("used_selections")?".available_selections":".used_selections";$(a.target).parent().appendTo($(this.el).find(c+
" .selection_options ul"))},show_unique_action:function(){this.show_unique_option=!this.show_unique_option;!0===this.show_unique_option?($(this.el).find(".available_selections, .used_selections").addClass("unique"),$(this.el).find(".available_selections, .used_selections").removeClass("caption")):($(this.el).find(".available_selections, .used_selections").addClass("caption"),$(this.el).find(".available_selections, .used_selections").removeClass("unique"))},use_result_action:function(){this.use_result_option=
!this.use_result_option;this.get_members()},save:function(){this.query.updatedSelectionFromModal=!0;var a=this,b=$("\x3cdiv\x3eSaving...\x3c/div\x3e");$(this.el).find(".dialog_body").children().hide();$(this.el).find(".dialog_body").prepend(b);var c=decodeURIComponent(a.member.hierarchy),d=decodeURIComponent(a.member.level),b=a.workspace.query.helper.getHierarchy(c),e=[];0!==$(this.el).find(".used_selections input").length&&(a.workspace.query.helper.removeAllLevelCalculatedMember(c),$(this.el).find(".used_selections .option_value input").each(function(b,
f){var h=$(f).val();if($(f).hasClass("cmember")){var k=$(f).attr("label");a.workspace.toolbar.group_parents();a.workspace.query.helper.includeLevelCalculatedMember(a.axis,c,d,decodeURIComponent(h),0);e.push({uniqueName:decodeURIComponent(h),caption:decodeURIComponent(k),type:"calculatedmember"})}else k=$(f).attr("label"),e.push({uniqueName:decodeURIComponent(h),caption:decodeURIComponent(k)})}));var f=$("#parameter").val();if(b&&b.levels.hasOwnProperty(d)){var h=[];if(!0===this.per_metrics_totals)$(".show_totals_select").each(function(){h.push($(this).val())});
else for(var k=a.workspace.query.model.queryModel.details.measures,l=0;l<k.length;l++)h.push($("#all_measures_select").val());b.levels[d].aggregators=h;k=$(a.el).find("input.selection_type:checked").val();b.levels[d].selection={type:k?k:"INCLUSION",members:e};Settings.ALLOW_PARAMETERS&&f&&(b.levels[d].selection.parameterName=f,a.workspace.query.helper.model())}this.finished()},finished:function(){$("#filter_selections").remove();this.available_members=null;$(this.el).find(".filterbox").autocomplete("destroy").remove();
...
"license expired"===a&&this.$el.find(".dialog_footer").find('a[href\x3d"#upload_license"]').show();this.$el.find(".clearlink").unbind()},show_panel_user:function(a){a.preventDefault();$(a.currentTarget).next().slideToggle("fast")},upload_license:function(a){a.preventDefault();a=window.location;""===a.search?window.open(a.href+"upload.html","_self"):window.open(a.origin+"/upload.html","_self")}}),AboutModal=Modal.extend({type:"login",message:'\x3cdiv class\x3d"about-us"\x3e\x3cdiv class\x3d"header"\x3e\x3cspan\x3e'+
Settings.VERSION+'\x3cspan\x3e\x3ca href\x3d"http://saiku.meteorite.bi" target\x3d"_blank"\x3ehttp://saiku.meteorite.bi\x3c/a\x3e\x3c/div\x3e\x3cdiv class\x3d"license-info"\x3e\x3ch3\x3eLicense Info\x3c/h3\x3e\x3cul\x3e\x3cli class\x3d"label"\x3eType: \x3cspan class\x3d"item license-type"\x3e\x3c/span\x3e\x3c/li\x3e\x3cli class\x3d"label item-license-expiration" hidden\x3eExpires: \x3cspan class\x3d"item license-expiration"\x3e\x3c/span\x3e\x3c/li\x3e\x3cli class\x3d"label"\x3eNumber of users: \x3cspan class\x3d"item license-user-limit"\x3e\x3c/span\x3e\x3c/li\x3e\x3cli class\x3d"label"\x3eLicensed to: \x3cspan class\x3d"item license-name"\x3e\x3c/span\x3e - \x3cspan class\x3d"item license-email"\x3e\x3c/span\x3e\x3c/li\x3e\x3cli\x3e\x3ca href\x3d"http://www.meteorite.bi/saiku-pricing" target\x3d"_blank"\x3eOrder more licenses here\x3c/a\x3e\x3c/li\x3e\x3c/ul\x3e\x3c/div\x3e\x3cdiv class\x3d"footer"\x3e\x3cspan\x3eWant to help? \x3ca href\x3d"https://www.paypal.com/uk/cgi-bin/webscr?cmd\x3d_flow\x26SESSION\x3dYV5t-PRrJWXJ1nMw9KlOlfrivAY32xkbYXJ1sGaCkmEIEZgLPBXuP_FKQL0\x26dispatch\x3d5885d80a13c0db1f8e263663d3faee8dc3f308debf7330dd8d0b0a9f21afd7d3\x26rapidsState\x3dDonation__DonationFlow___StateDonationLogin\x26rapidsStateSignature\x3d16fabaac8c6b9c132f78003cf605e5237537aa2b" target\x3d"_blank"\x3eMake a donation\x3c/a\x3e or \x3ca href\x3d"https://github.com/OSBI/saiku" target\x3d"_blank"\x3econtribute to the code!\x3c/a\x3e\x3c/span\x3e\x3cspan\x3ePowered by \x3cimg src\x3d"images/src/meteorite_free.png" width\x3d"20px"\x3e \x3ca href\x3d"http://www.meteorite.bi/services/consulting" target\x3d"_blank"\x3ewww.meteorite.bi\x3c/a\x3e\x3c/span\x3e\x3c/div\x3e\x3c/div\x3e',
events:{"click .dialog_footer a":"call"},initialize:function(a){_.extend(this,a);this.options.title='\x3cspan class\x3d"i18n"\x3eAbout\x3c/span\x3e '+Settings.VERSION;this.bind("open",function(){this.render_license_info()})},render_license_info:function(){var a="community_edition"===Settings.LICENSE.licenseType?"Open Source License":Settings.LICENSE.licenseType,b;Settings.LICENSE.expiration&&(b=new Date(parseFloat(Settings.LICENSE.expiration)),this.$el.find(".item-license-expiration").show(),this.$el.find(".license-expiration").text(b.toLocaleDateString()));
this.$el.find(".license-type").text(a);this.$el.find(".license-user-limit").text(Settings.LICENSE.userLimit);this.$el.find(".license-name").text(Settings.LICENSE.name);this.$el.find(".license-email").text(Settings.LICENSE.email)}}),OverwriteModal=Modal.extend({type:"info",message:"Are you sure you want to overwrite the existing query?",buttons:[{text:"Yes",method:"save"},{text:"No",method:"close"}],initialize:function(a){_.extend(this,a);this.options.title="Warning";this.queryname=this.name;this.queryfolder=
this.foldername;this.parentobj=this.parent},dummy:function(){return!0},save:function(a){a.preventDefault();this.parentobj.save_remote(this.queryname,this.queryfolder,this.parentobj);this.$el.dialog("destroy").remove()}}),AddFolderModal=Modal.extend({type:"save",closeText:"Save",events:{"click .form_button":"save","submit form":"save"},buttons:[{text:"OK",method:"save"}],initialize:function(a){this.success=a.success;this.path=a.path;this.message="\x3cform id\x3d'add_folder'\x3e\x3clabel class\x3d'i18n' for\x3d'name'\x3eTo add a new folder, please type a name in the text box below:\x3c/label\x3e\x3cinput type\x3d'text' class\x3d'form-control newfolder' name\x3d'name' /\x3e\x3c/form\x3e";
_.extend(this.options,{title:"Add Folder"});if(isIE&&9>isIE)$(this.el).find("form").on("submit",this.save)},save:function(a){a.preventDefault();a=$(this.el).find('input[name\x3d"name"]').val();(new SavedQuery({file:this.path+a,name:a})).save({},{success:this.success,dataType:"text",error:this.error});this.close();return!1},error:function(){$(this.el).find("dialog_body").html("Could not add new folder")}}),FilterModal=Modal.extend({type:"filter",closeText:"Save",events:{"click .dialog_footer a":"call",
"click .insert-member":"open_select_member_selector"},buttons:[{text:"OK",method:"save"},{text:"Cancel",method:"close"},{text:"Help",method:"help"}],message:"",expression_text:function(){var a="\x3cdiv class\x3d'sidebar'\x3e\x3ctable border\x3d'0px'\x3e";"Order"==this.expressionType&&(a+="\x3ctr\x3e\x3ctd class\x3d'col1'\x3e\x3clabel\x3eSort Type\x3c/label\x3e \x3cselect class\x3d'form-control' id\x3d'fun'\x3e\x3coption\x3eASC\x3c/option\x3e\x3coption\x3eBASC\x3c/option\x3e\x3coption\x3eDESC\x3c/option\x3e\x3coption\x3eBDESC\x3c/option\x3e \x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e");
...
selectDimension:a,dimension:c,hierarchy:b,uniqueName:this.pmUniqueName,lastLevel:this.pmLevel,breadcrumbs:this.pmBreadcrumbs,select_type:"select_member",selected_member:this.selected_member,close_callback:function(a){e.close_select_modal(d,a)}})).render().open();this.$el.parents(".ui-dialog").find(".ui-dialog-title").text("Custom Filter")},close_select_modal:function(a,b){a.insert(b)},help:function(){window.open("http://saiku-documentation.readthedocs.io/en/latest/filtering.html")}}),CustomFilterModal=
Modal.extend({type:"filter",closeText:"Save",events:{"submit form":"save","change .function":"switch_function","change .type":"switch_type","click .dialog_footer a":"call"},buttons:[{text:"OK",method:"save"},{text:"Cancel",method:"close"}],message:"\x3cform id\x3d'custom_filter'\x3e\x3ctable border\x3d'0px'\x3e\x3ctr\x3e\x3ctd class\x3d'col0'\x3eDefine Filter\x3cselect class\x3d'form-control function'\x3e\x3coption\x3eSelect a Function...\x3c/option\x3e\x3coption value\x3d'TopCount'\x3eTopCount\x3c/option\x3e\x3coption value\x3d'TopPercent'\x3eTopPercent\x3c/option\x3e\x3coption value\x3d'TopSum'\x3eTopSum\x3c/option\x3e\x3coption value\x3d'BottomCount'\x3eBottomCount\x3c/option\x3e\x3coption value\x3d'BottomPercent'\x3eBottomPercent\x3c/option\x3e\x3coption value\x3d'BottomSum'\x3eBottomSum\x3c/option\x3e\x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide'\x3e\x3ctd\x3e\x3cspan class\x3d'ntype'\x3e\x3c/span\x3e\x3cinput class\x3d'n form-control' /\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide'\x3e\x3ctd\x3eSort by\x3cselect class\x3d'type form-control'\x3e\x3coption value\x3d'measure'\x3eMeasure\x3c/option\x3e\x3coption value\x3d'custom'\x3eMDX Expression\x3c/option\x3e\x3c/select\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr class\x3d'filter_details hide sortingoption'\x3e\x3ctd\x3e\x26nbsp; \x26nbsp;\x3c/td\x3e\x3c/table\x3e\x3c/form\x3e",
func:null,func_type:"Measure",n:"",sortliteral:"",measure_list:null,initialize:function(a){var b=this;this.axis=a.axis;this.measures=a.measures;this.query=a.query;this.success=a.success;this.func=a.func;this.n=a.n;this.sortliteral=a.sortliteral;this.isMdx=!0;_.bindAll(this,"build_measures_list","save");this.measure_list=this.build_measures_list();_.extend(this.options,{title:"Custom Filter for "+this.axis});this.bind("open",function(){b.func&&($(b.el).find(".function").val(b.func),b.switch_function({target:$(b.el).find(".function")}),
...
var b=this.$el.find("#cms-dimension option:selected").val(),c=this.$el.find("#cms-dimension option:selected").text(),d=this.$el.find("#cms-dimension option:selected").data("dimension"),e=this.$el.find("#cms-dimension option:selected").data("type"),f=this.$el.find(".formula-editor").attr("id"),h=ace.edit(f),k=this;$(a.currentTarget).hasClass("btn-select-member")?((new ParentMemberSelectorModal({dialog:this,workspace:this.workspace,cube:this.workspace.selected_cube,dimensions:Saiku.session.sessionworkspace.cube[this.workspace.selected_cube].get("data").dimensions,
selectDimension:b,dimension:d,hierarchy:c,uniqueName:this.pmUniqueName,lastLevel:this.pmLevel,breadcrumbs:this.pmBreadcrumbs,select_type:"select_member",selected_member:this.selected_member,close_callback:function(a){k.close_select_modal(h,a)}})).render().open(),this.$el.parents(".ui-dialog").find(".ui-dialog-title").text("Connection Details")):"calcmember"===e&&((new ParentMemberSelectorModal({dialog:this,workspace:this.workspace,cube:this.workspace.selected_cube,dimensions:Saiku.session.sessionworkspace.cube[this.workspace.selected_cube].get("data").dimensions,
selectDimension:b,dimension:d,hierarchy:c,uniqueName:this.pmUniqueName,lastLevel:this.lastLevel,current_level:this.pmLevel,breadcrumbs:this.pmBreadcrumbs})).render().open(),this.$el.parents(".ui-dialog").find(".ui-dialog-title").text("Connection Details"))},close_select_modal:function(a,b){a.insert(b)},help:function(){window.open("http://saiku-documentation.readthedocs.io/en/latest/calculated_members.html?highlight\x3dcalculated%20members")}}),GrowthModal=Modal.extend({type:"filter",closeText:"Save",
measureExpression:"",selectedMeasure:"",selectedDimension:"",asPercent:!1,asPercentAround100:!1,asPercentAlternative:!1,events:{"click .dialog_footer a":"call","submit form":"save","change #Measures":"addMeasureToCalculationField","change #Dimensions":"addDimensionToCalculationField",'click [type\x3d"checkbox"]':"setAbsoluteOrRelative"},buttons:[{text:"OK",method:"save"},{text:"Cancel",method:"close"}],addMeasureTemplate:_.template(" \x3cspan class\x3d'i18n'\x3eCalculate difference of a measure over dimension members\x3c/span\x3e \x3cform id\x3d'measureGrowthForm'\x3e\x3ctable border\x3d'0px'\x3e\x3ctr\x3e\x3ctd class\x3d'col0 i18n'\x3eName:\x3c/td\x3e\x3ctd class\x3d'col1'\x3e\x3cinput type\x3d'text' class\x3d'form-control measure_name i18n' value\x3d'Measure Name'\x3e\x3c/input\x3e\x3c/td\x3e\x3c/tr\x3e\x3cinput type\x3d\"checkbox\" name\x3d\"asPercent\" value\x3d\"asPercent\" id\x3d\"asPercentCheckbox\"\x3e\x26nbsp;\x3clabel class\x3d\"i18n\"\x3eRelative %?\x3c/label\x3e\x3cbr\x3e\x3c% if(dimensions.length\x3c2){ %\x3e\x3cinput type\x3d\"checkbox\" name\x3d\"asPercentAlt\" disabled value\x3d\"asPercentAlt\" id\x3d\"asPercentAltCheckbox\"\x3e\x26nbsp;\x3clabel class\x3d\"i18n\"\x3e% of Measure\x3c/label\x3e\x3cbr\x3e\x3c% }  else {%\x3e\x3cinput type\x3d\"checkbox\" name\x3d\"asPercentAlt\" value\x3d\"asPercentAlt\" id\x3d\"asPercentAltCheckbox\"\x3e\x26nbsp;\x3clabel class\x3d\"i18n\"\x3e% of Measure\x3c/label\x3e\x3cbr\x3e\x3c% }%\x3e\x3cinput type\x3d\"checkbox\" name\x3d\"asPercentAround100\" value\x3d\"asPercentAround100\" id\x3d\"asPercentAround100Checkbox\"\x3e\x26nbsp;\x3clabel class\x3d\"i18n\"\x3eRelative around 100%?\x3c/label\x3e\x3cbr\x3e\x3ctr\x3e\x3ctd class\x3d'col0 i18n'\x3eMeasure:\x3c/td\x3e\x3ctd class\x3d'col1'\x3e\x3cselect id\x3d'Measures' class\x3d'form-control i18n' name\x3d'MeasuresId' title\x3d'Select the measure from which the difference should be calculated'\x3e     \x3coption value\x3d'' selected\x3d'selected' class\x3d'i18n'\x3e--select an existing measure--\x3c/option\x3e     \x3c% _(measures).each(function(m) { %\x3e       \x3coption value\x3d'\x3c%\x3d m.uniqueName %\x3e'\x3e\x3c%\x3d m.name %\x3e\x3c/option\x3e     \x3c% }); %\x3e \x3c/select\x3e \x3c/td\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd class\x3d'col0 i18n'\x3eDimension:\x3c/td\x3e\x3ctd class\x3d'col1'\x3e\x3cselect id\x3d'Dimensions' name\x3d'DimensionsId' class\x3d'form-control i18n' title\x3d'This dimension attribute is used to calculate the difference of the selected measure. E.g. Calculate the growth over the years.'\x3e     \x3coption value\x3d'' selected\x3d'selected' class\x3d'i18n'\x3e--select a dimension from your query--\x3c/option\x3e     \x3c% _(dimensions).each(function(dim) { %\x3e       \x3coption value\x3d'\x3c%\x3d dim %\x3e'\x3e\x3c%\x3d dim %\x3e\x3c/option\x3e     \x3c% }); %\x3e \x3c/select\x3e \x3c/td\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd class\x3d'col0 i18n'\x3eFormat:\x3c/td\x3e\x3ctd class\x3d'col1'\x3e\x3cinput class\x3d'measure_format' type\x3d'text' class\x3d'form-control' value\x3d'#,##0.00'\x3e\x3c/input\x3e\x3c/td\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd class\x3d'col0 i18n'\x3eFormula:\x3c/td\x3e\x3ctd class\x3d'col1'\x3e\x3ctextarea class\x3d'measureFormula auto-hint' class\x3d'form-control i18n' placeholder\x3d'This field will automatically be constructed by selecting a measure and growth dimension from the dropdown lists above...'\x3e\x3c/textarea\x3e\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/form\x3e"),
...
this.memberExpression=[];for(var c=$(this.el).find("#Dimensions").val(),d=!1,e=this.calculate_nonempty_crossjoin(b),f=0;f<b.length;f++){var h=b[f];if(c===h.name)d=!0;else if(1==d){var k=this.calculated_generate(e,h),l=h.name,h=h.dimension;this.memberExpression.push({dimension:h,hierarchy:l,statement:"sum("+k+")",uniqueName:l+".["+h+"*TOTAL_MEMBER_SEL~SUM]",name:h+"*TOTAL_MEMBER_SEL~SUM"})}}var g="";_.each(this.memberExpression,function(a){g+=","+a.uniqueName});this.measureExpression=a+"/("+a+g+")"}else this.measureExpression=
...
"}";var d=a.levels,d=Object.keys(d)[Object.keys(d).length-1];return a.name+".["+d+"].MEMBERS"}}),FormatAsPercentageModal=Modal.extend({type:"filter",closeText:"Save",generatedMeasures:[],selectedMeasure:"",selectedDimension:"",asPercent:!0,events:{"click .dialog_footer a":"call","click .formatButton":"format"},buttons:[{text:"Cancel",method:"close"},{text:"Help",method:"help"}],addMeasureTemplate:_.template("\x3cdiv class\x3d'text'\x3e\x3cspan class\x3d'i18n'\x3eName:\x3c/span\x3e \x3cinput type\x3d'text' class\x3d'measure_name form-control'\x3e\x3c/input\x3e \x3c/div\x3e \x3cdiv\x3e\x3cspan class\x3d'i18n'\x3eSelect how to express the measures:\x3c/span\x3e \x3c/div\x3e\x3col style\x3d'list-style-type: none;'\x3e \x3cli style\x3d'padding-bottom: 10px; padding-right: 10px; float: inherit;'\x3e         \x3cbutton class\x3d'form_button btn btn-primary formatButton i18n' id\x3d'formatOverRows'\x3e Format as % of rows \x3c/button\x3e\x3c/li\x3e\x3cli style\x3d'padding-bottom: 10px; padding-right: 10px; float: inherit;'\x3e         \x3cbutton class\x3d'form_button btn btn-primary formatButton i18n' id\x3d'formatOverColumns'\x3e Format as % of columns \x3c/button\x3e\x3c/li\x3e\x3cli style\x3d'padding-bottom: 10px; padding-right: 10px; float: inherit;'\x3e         \x3cbutton class\x3d'form_button formatButton btn btn-primary i18n' id\x3d'formatOverTotal'\x3e Format as % of total \x3c/button\x3e\x3c/li\x3e\x3c/ol\x3e\x3cspan id\x3d'userFeedback' class\x3d'i18n'\x3e\x3cp class\x3d'i18n'\x3e\x3c%\x3d userFeedback %\x3e\x3c/p\x3e\x3c/span\x3e"),
...
$(a.workspace.el).find(".fields_list .disabled_toolbar").removeClass("disabled_toolbar"),$(a.workspace.toolbar.el).find(".about, .new, .open, .save, .edit, .run,.auto,.non_empty,.toggle_fields,.toggle_sidebar,.switch_to_mdx, .mdx").removeClass("disabled_toolbar"));this.reflect_properties()},template:function(){var a=$("#template-workspace-toolbar").html()||"";return _.template(a)()},render:function(){$(this.el).html(this.template());return this},translate:function(){},call:function(a){a.preventDefault();
var b=a.target.hash.replace("#","");if(!$(a.target).hasClass("disabled_toolbar")&&this[b])this[b](a);return!1},reflect_properties:function(){var a=this.workspace.query.model.properties?this.workspace.query.model.properties:Settings.QUERY_PROPERTIES;!0===a["saiku.olap.query.nonempty"]&&$(this.el).find(".non_empty").addClass("on");!0===a["saiku.olap.query.automatic_execution"]&&$(this.el).find(".auto").addClass("on");!0!==a["saiku.olap.query.drillthrough"]&&$(this.el).find(".drillthrough, .drillthrough_export").addClass("disabled_toolbar");
!0!==a["org.saiku.query.explain"]&&$(this.el).find(".explain_query").addClass("disabled_toolbar");!0!==a["org.saiku.connection.scenario"]?$(this.el).find(".query_scenario").addClass("disabled_toolbar"):($(this.el).find(".query_scenario").removeClass("disabled_toolbar"),$(this.el).find(".drillthrough, .drillthrough_export").addClass("disabled_toolbar"));"true"!=a["saiku.olap.query.limit"]&&!0!==a["saiku.olap.query.filter"]||$(this.workspace.el).find(".fields_list_header").addClass("limit");"undefined"!==
this.workspace.query.getProperty("saiku.olap.result.formatter")&&"flattened"==this.workspace.query.getProperty("saiku.olap.result.formatter")&&($(this.el).find(".group_parents").hasClass("on")||$(this.el).find(".group_parents").addClass("on"));0<$(this.workspace.el).find(".workspace_results tbody.ui-selectable").length&&$(this.el).find(".zoom_mode").addClass("on");$(this.el).find(".spark_bar, .spark_line").removeClass("on");$(this.el).find("a.edit").removeClass("disabled_toolbar");"VIEW"==Settings.MODE||
this.workspace.isReadOnly?($(this.el).find("a.edit").hide(),$(this.el).find("a.save").hide()):("view"==this.workspace.viewState?$(this.el).find("a.edit").removeClass("on"):$(this.el).find("a.edit").addClass("on"),$(this.el).find("a.edit").show("normal"))},new_query:function(a){"undefined"!=typeof ga&&ga("send","event","Toolbar","New Query");this.workspace.switch_view_state("edit");this.workspace.new_query();return!1},edit_query:function(a){$(a.target).toggleClass("on");$(a.target).hasClass("on")?
this.workspace.switch_view_state("edit"):this.workspace.switch_view_state("view")},save_query:function(a){this.workspace.query&&("undefined"!=typeof this.editor&&(a=this.editor.getValue(),this.workspace.query.model.mdx=a),(new SaveQuery({query:this.workspace.query})).render().open())},open_query:function(a){(new OpenDialog).render().open()},run_query:function(a){this.workspace.query.run(!0)},automatic_execution:function(a){var b=!this.workspace.query.getProperty("saiku.olap.query.automatic_execution");
this.workspace.query.setProperty("saiku.olap.query.automatic_execution",b);b?$(a.target).addClass("on"):$(a.target).removeClass("on")},toggle_fields:function(a){a&&$(this.el).find(".toggle_fields").toggleClass("on");$(this.el).find(".toggle_fields").hasClass("on")?this.toggle_fields_action("show"):this.toggle_fields_action("hide")},toggle_fields_action:function(a,b){"show"==a&&$(".workspace_editor").is(":visible")||"hide"==a&&$(".workspace_editor").is(":hidden")||(b?($(".workspace_editor").css("height",
""),$(".workspace_editor").is(":hidden")?$(".workspace_editor").show():$(".workspace_editor").hide()):"hide"==a?$(this.workspace.el).find(".workspace_editor").hide():$(this.workspace.el).find(".workspace_editor").show())},about:function(){(new AboutModal).render().open();return!1},toggle_sidebar:function(){this.workspace.toggle_sidebar()},group_parents:function(a){a&&$(a.target).toggleClass("on");this.$el.find(".group_parents").hasClass("on")?this.workspace.query.setProperty("saiku.olap.result.formatter",
"flattened"):this.workspace.query.setProperty("saiku.olap.result.formatter","flat");this.workspace.query.run()},non_empty:function(a){var b=!this.workspace.query.getProperty("saiku.olap.query.nonempty");this.workspace.query.helper.nonEmpty(b);this.workspace.query.setProperty("saiku.olap.query.nonempty",b);$(a.target).toggleClass("on");this.workspace.query.run()},swap_axis:function(a){$(this.workspace.el).find(".workspace_results table").html("");this.workspace.query.helper.swapAxes();this.workspace.sync_query();
this.workspace.query.run(!0)},check_modes:function(a){if("undefined"!==typeof a&&null!==a)if(0<$(this.workspace.el).find(".workspace_results tbody.ui-selectable").length&&$(this.workspace.el).find(".workspace_results tbody").selectable("destroy"),!$(a).hasClass("on"))$(this.workspace.el).find("td.data").removeClass("cellhighlight").unbind("click"),$(this.workspace.el).find(".table_mode").removeClass("on"),this.workspace.query.run();else if($(a).hasClass("drillthrough_export"))$(this.workspace.el).find("td.data").addClass("cellhighlight").unbind("click").click(this.clicked_cell_drillthrough_export),
$(this.workspace.el).find(".query_scenario, .drillthrough, .zoom_mode, .drillacross").removeClass("on");else if($(a).hasClass("drillthrough"))$(this.workspace.el).find("td.data").addClass("cellhighlight").unbind("click").click(this.clicked_cell_drillthrough),$(this.workspace.el).find(".query_scenario, .drillthrough_export, .zoom_mode, .drillacross").removeClass("on");else if($(a).hasClass("query_scenario"))this.workspace.query.scenario.activate(),$(this.workspace.el).find(".drillthrough, .drillthrough_export, .zoom_mode, .drillacross").removeClass("on");
else if($(a).hasClass("drillacross"))$(this.workspace.el).find("td.data").addClass("cellhighlight").unbind("click").click(this.clicked_cell_drillacross),$(this.workspace.el).find(".query_scenario, .drillthrough, .drillthrough_export, .zoom_mode").removeClass("on");else if($(a).hasClass("zoom_mode")){var b=this;$(b.workspace.el).find(".workspace_results tbody").selectable({filter:"td",stop:function(a,d){var e=[];$(b.workspace.el).find(".workspace_results").find("td.ui-selected div").each(function(a,
b){var c=$(b).attr("rel");c&&e.push(c)});$(b.workspace.el).find(".workspace_results").find(".ui-selected").removeClass(".ui-selected");e=_.uniq(e);0<e.length&&b.workspace.query.action.put("/zoomin",{success:function(a,c){b.workspace.query.parse(c);b.workspace.unblock();b.workspace.sync_query();Saiku.ui.unblock();b.workspace.query.run()},data:{selections:JSON.stringify(e)}})}});$(this.workspace.el).find(".drillthrough, .drillthrough_export, .query_scenario, .drillacross, .about").removeClass("on")}},
query_scenario:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},zoom_mode:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},drillacross:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},drillthrough:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},display_drillthrough:function(a,b){this.workspace.table.render({data:b});Saiku.ui.unblock()},export_drillthrough:function(a){$(a.target).toggleClass("on");this.check_modes($(a.target))},
clicked_cell_drillacross:function(a){$target=$(a.target).hasClass("data")?$(a.target).find("div"):$(a.target);a=$target.attr("rel");(new DrillAcrossModal({workspace:this.workspace,title:"Drill Across",action:"export",position:a,query:this.workspace.query})).open()},clicked_cell_drillthrough_export:function(a){$target=$(a.target).hasClass("data")?$(a.target).find("div"):$(a.target);a=$target.attr("rel");(new DrillthroughModal({workspace:this.workspace,maxrows:1E4,title:"Drill-Through to CSV",action:"export",
position:a,query:this.workspace.query})).open()},clicked_cell_drillthrough:function(a){$target=$(a.target).hasClass("data")?$(a.target).find("div"):$(a.target);a=$target.attr("rel");(new DrillthroughModal({workspace:this.workspace,maxrows:200,title:"Drill-Through",action:"table",success:this.display_drillthrough,position:a,query:this.workspace.query})).open()},swap_axes_on_dropzones:function(a,b){this.workspace.query.parse(b);this.workspace.unblock();this.workspace.sync_query();Saiku.ui.unblock();
this.workspace.unblock();this.workspace.sync_query();Saiku.ui.unblock()},show_mdx:function(a){(new MDXModal({mdx:this.workspace.query.model.mdx})).render().open()},workspace_report_titles:function(a){(new ReportTitlesModal({query:this.workspace.query})).render().open()},export_xls:function(a){void 0!=this.workspace.query.name?(a=this.workspace.query.name.substring(this.workspace.query.name.lastIndexOf("/")+1).slice(0,-5),window.location=Settings.REST_URL+this.workspace.query.url()+"/export/xls/"+
this.workspace.query.getProperty("saiku.olap.result.formatter")+'?exportname\x3d"'+encodeURIComponent(a)+'xls"'):window.location=Settings.REST_URL+this.workspace.query.url()+"/export/xls/"+this.workspace.query.getProperty("saiku.olap.result.formatter")},export_csv:function(a){void 0!=this.workspace.query.name?(a=this.workspace.query.name.substring(this.workspace.query.name.lastIndexOf("/")+1).slice(0,-6),window.location=Settings.REST_URL+this.workspace.query.url()+"/export/csv/"+this.workspace.query.getProperty("saiku.olap.result.formatter")+
'?exportname\x3d"'+encodeURIComponent(a)+'"'):window.location=Settings.REST_URL+this.workspace.query.url()+"/export/csv/"+this.workspace.query.getProperty("saiku.olap.result.formatter")},export_pdf:function(a){void 0!=this.workspace.query.name?(a=this.workspace.query.name.substring(this.workspace.query.name.lastIndexOf("/")+1).slice(0,-6),window.location=Settings.REST_URL+this.workspace.query.url()+"/export/pdf/"+this.workspace.query.getProperty("saiku.olap.result.formatter")+'?exportname\x3d"'+encodeURIComponent(a)+
'"'):window.location=Settings.REST_URL+this.workspace.query.url()+"/export/pdf/"+this.workspace.query.getProperty("saiku.olap.result.formatter")},switch_to_mdx:function(a){var b=this;$(this.workspace.el).find(".workspace_fields").addClass("hide");$(this.el).find(".auto, .query_scenario, .buckets, .non_empty, .swap_axis, .mdx, .switch_to_mdx, .zoom_mode, .drillacross").parent().hide();0<$(this.workspace.el).find(".workspace_results tbody.ui-selectable").length&&$(this.workspace.el).find(".workspace_results tbody").selectable("destroy");
$(this.el).find(".run").attr("href","#run_mdx");$(this.el).find(".run, .save, .open, .new, .edit").removeClass("disabled_toolbar");if("view"!=Settings.MODE&&"table"!=Settings.MODE&&!this.workspace.isReadOnly){$mdx_editor=$(this.workspace.el).find(".mdx_input");$(this.workspace.el).find(".workspace_editor .mdx_input, .workspace_editor .editor_info, .workspace_editor").removeClass("hide").show();this.editor=ace.edit("mdx_editor");this.editor.setShowPrintMargin(!1);this.editor.setFontSize(11);this.editor.commands.addCommand({name:"runmdx",
bindKey:{win:"Ctrl-Enter",mac:"Command-Enter"},exec:function(a){b.run_mdx()},readOnly:!0});a=function(){var a=b.editor.getCursorPosition();$mdx_editor.parent().find(".editor_info").html("\x26nbsp; "+(a.row+1)+", "+a.column)};this.editor.on("changeSelection",a);a();var c=function(){var a=$(document).height()/3,a=Math.floor(a/b.editor.renderer.lineHeight),a=((b.editor.getSession().getScreenLength()>a?a:b.editor.getSession().getScreenLength())+1)*b.editor.renderer.lineHeight+b.editor.renderer.scrollBar.getWidth();
$mdx_editor.height(a.toString()+"px");b.editor.resize();b.workspace.adjust()};a=function(){var a=b.editor.session;b.editor.resize();a.setUseWrapMode(!0);if(a.getUseWrapMode()){var c=b.editor.renderer.characterWidth,f=b.editor.renderer.scroller.clientWidth;0<f&&a.setWrapLimitRange(null,parseInt(f/c,10))}};a();c();b.editor.focus();b.editor.clearSelection();b.editor.getSession().setValue("");b.editor.getSession().on("change",c);$(window).resize(a);b.editor.on("changeSelection",c);b.editor.on("focus",
function(a){c();return!0});b.editor.on("blur",function(a){100<$(b.workspace.el).find(".mdx_input").height()&&$(b.workspace.el).find(".mdx_input").height(100);b.editor.resize();b.workspace.adjust();return!0});this.editor.getSession().setMode("ace/mode/text")}this.workspace.dimension_list&&$(this.workspace.el).find(".sidebar_inner ul li a").css({fontWeight:"normal"}).parent("li").removeClass("ui-draggable ui-draggable-disabled ui-state-disabled");this.activate_buttons({workspace:this.workspace});$(this.workspace.toolbar.el).find(".run").removeClass("disabled_toolbar");
$(this.workspace.table.el).empty();this.workspace.timeSeriesFilter&&$(this.workspace.timeSeriesFilter.el).empty();this.workspace.adjust();this.post_mdx_transform()},post_mdx_transform:function(){var a=this;"MDX"!==this.workspace.query.model.type&&(this.workspace.query.model.queryModel={},this.workspace.query.model.type="MDX",this.workspace.query.setProperty("saiku.olap.result.formatter","flat"),a.workspace.query.helper.model().parameters={});var b=this.workspace.query.model.mdx;a.editor&&(a.editor.setValue(b,
0),a.editor.clearSelection(),a.editor.focus());$(a.el).find(".group_parents").removeClass("on");if(Settings.ALLOW_PARAMETERS){var c=function(){var b=a.editor.getValue(),c=[];if(b)for(var f=0,h=b.length;f<h-1;f++)if("$"===b[f]&&"{"===b[f+1]){for(var k="",l=!1,f=f+2;f<h;f++)if("}"!==b[f])k+=b[f];else{l=!0;f++;break}l&&k&&0<k.length&&c.push(k)}var g=a.workspace.query.helper.model().parameters,m={};_.each(c,function(a){m[a]=g[a]?g[a]:""});a.workspace.query.helper.model().parameters=m;a.workspace.update_parameters()},
b=function(){_.delay(c,1E3)};a.editor&&(a.editor.getSession().off("change",b),a.editor.getSession().on("change",b));a.workspace.update_parameters()}},run_mdx:function(a){100<$(this.workspace.el).find(".mdx_input").height()&&$(this.workspace.el).find(".mdx_input").height(100);this.editor.resize();a=this.editor.getValue();this.workspace.query.model.mdx=a;this.workspace.query.run(!0)},explain_query:function(a){this.workspace.query.action.gett("/explain",{success:function(a,c){var d="\x3ctextarea style\x3d'width: "+
($("body").width()-165)+"px;height:"+($("body").height()-175)+"px;'\x3e",d=null!==c&&null!==c.error?d+c.error:c.cellset&&0===c.cellset.length?d+"Empty explain plan!":d+c.cellset[1][0].value,d=d+"\x3c/textarea\x3e";Saiku.ui.unblock();$.fancybox('\x3cdiv id\x3d"fancy_results" class\x3d"workspace_results" style\x3d"overflow:visible"\x3e\x3ctable\x3e\x3ctr\x3e\x3cth clas\x3d"row_header"\x3eExplain Plan\x3c/th\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd\x3e'+d+"\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/div\x3e",{autoDimensions:!1,
autoScale:!1,height:$("body").height()-100,width:$("body").width()-100,transitionIn:"none",transitionOut:"none"})}});return!1}}),WorkspaceDropZone=Backbone.View.extend({template:function(){var a=$("#template-workspace-dropzones").html()||"";return _.template(a)()},events:{"sortstop .fields_list_body.details":"set_measures","sortstop .axis_fields":"select_dimension","click .d_measure":"remove_measure_click","click .d_level":"selections","click .measure_fields.limit":"measure_action","click .axis_fields_header.limit":"limit_axis",
...
this.set_measures();else{var c=this,d=$(b.helper).find("a").attr("hierarchy");$(this.el).find('ul.hierarchy[hierarchy\x3d"'+d+'"]').parents(".fields_list").attr("title");var e=$(b.helper).find("a").attr("level");Settings.ALLOW_PARAMETERS&&($.each($(b.helper).find("li"),function(a,b){$(b).hasClass("temphide")&&(e=$(b).find("a").attr("level"),c.workspace.query.helper.removeParameter(d,e))}),this.workspace.$el.find(".parameter_input").empty());this.workspace.query.helper.removeHierarchy(d);this.workspace.sync_query();
this.workspace.query.run()}},synchronize_query:function(){var a=this;this.reset_dropzones();var b=this.workspace.query.helper.model();if(b.hasOwnProperty("queryModel")&&b.queryModel.hasOwnProperty("axes")){var c=b.queryModel.axes,d;for(d in c){var e=$(a.el).find('.fields_list[title\x3d"'+d+'"]');_.each(c[d].hierarchies,function(b){if(null!=a.workspace.dimension_list){var c=$(a.workspace.dimension_list.el).find('ul.d_hierarchy[hierarchy\x3d"'+b.name+'"]').clone().removeClass("d_hierarchy").addClass("hierarchy");
c.find("li.d_level").hide();for(var d in b.levels)c.find('li a[level\x3d"'+d+'"]').parent().show(),$(a.workspace.dimension_list.el).find('ul.d_hierarchy[hierarchy\x3d"'+b.name+'"] li a[level\x3d"'+d+'"]').parent().draggable("disable").parents(".parent_dimension").find(".folder_collapsed").addClass("selected");b=$('\x3cli class\x3d"selection"\x3e\x3c/li\x3e');b.append(c);b.appendTo(e.find("ul.connectable"))}})}_.each(b.queryModel.details.measures||[],function(b){null!=a.workspace.dimension_list&&(b=
$(a.workspace.dimension_list.el).find('.measure_tree a.measure[measure\x3d"'+b.name+'"]').parent(),b.clone().show().appendTo($(a.el).find(".fields_list_body.details ul.connectable")),b.draggable("disable"))});this.update_dropzones()}},reset_dropzones:function(){$(this.el).find(".fields_list_body ul.connectable").find("li.selection, li.d_measure").remove();null!=this.workspace.dimension_list&&$(this.workspace.dimension_list.el).find("li.ui-draggable-disabled").draggable("enable");$(this.el).find('.fields_list[title\x3d"ROWS"] .limit').removeClass("on");
...
var b=this.workspace.query.helper.getAxis(a),c=b?b.hierarchies.length:0,d=!1,e,f;if(Settings.ALLOW_PARAMETERS)for(var h=0;h<c;h++){for(var k in b.hierarchies[h].levels)b.hierarchies[h].levels.hasOwnProperty(k)&&b.hierarchies[h].levels[k].selection&&b.hierarchies[h].levels[k].selection.parameterName&&(f=k,e=b.hierarchies[h].name,this.workspace.query.helper.removeParameter(e,f));h===c-1&&(d=!0,this.workspace.$el.find(".parameter_input").empty())}if(d||!Settings.ALLOW_PARAMETERS||"DETAILS"===a)return"DETAILS"===
a?this.workspace.query.helper.clearMeasures():this.workspace.query.helper.clearAxis(a),Saiku.session.trigger("workspaceDropZone:clear_axis",{workspace:this.workspace,axis:a}),this.workspace.sync_query(),this.workspace.query.run(),!1},select_dimension:function(a,b){Saiku.session.trigger("workspaceDropZone:select_dimension",{workspace:this.workspace});if($(b.item).is(":visible")){$(this.el).find(".axis_fields ul.hierarchy").each(function(a,b){$(b).find("li.temphide").show().removeClass("temphide")});
var c=b.item.find(".level").attr("hierarchy"),d=-1;b.item.parents("ul.connectable").find("li.selection").each(function(a,b){$(b).find("ul.hierarchy").attr("hierarchy")==c&&(d=a)});var e=b.item.parents(".axis_fields").parent().attr("title"),f=$(a.target).parents(".axis_fields").parent().attr("title"),h=b.item.hasClass("d_level"),k=b.item.hasClass("dimension-level-calcmember"),l;k||(h?(l=b.item.find("a.level").attr("level"),this.workspace.query.helper.includeLevel(e,c,l,d)):this.workspace.query.helper.moveHierarchy(f,
e,c,d));$(b.item).detach();this.workspace.sync_query();this.workspace.query.run();Saiku.events.trigger("workspaceDropZone:select_dimension",this,{level:l,uniquename:void 0,toAxis:e,isNew:h,isCalc:k,hierarchy:c})}},find_type_time:function(a,b,c){void 0===this.workspace.metadata&&(this.workspace.metadata=Saiku.session.sessionworkspace.cube[this.workspace.selected_cube]);var d={};d.dimensions=_.findWhere(this.workspace.metadata.attributes.data.dimensions,{name:a});void 0===b&&(b=a);d.hierarchies=_.findWhere(d.dimensions.hierarchies,
{name:b});if(void 0===d.hierarchies||null===d.hierarchies)d.hierarchies=_.findWhere(d.dimensions.hierarchies,{name:a+"."+b});d.level=_.findWhere(d.hierarchies.levels,{name:c});if(null===d.level||void 0===d.level)d.level=_.findWhere(d.hierarchies.levels,{caption:c});return d},selections:function(a,b){a&&a.preventDefault();var c=$(a.target).hasClass("d_level")?$(a.target).find(".level"):$(a.target),d=c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[0],e=c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[1]?
c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[1]:c.attr("hierarchy").replace(/[\[\]]/gi,"").split(".")[0],f=c.attr("level"),h=this.find_type_time(d,e,f),k=c.attr("hierarchy"),l=c.attr("href").replace("#","");this.member=new Member({},{cube:this.workspace.selected_cube,dimension:l});var g=decodeURIComponent(this.member.hierarchy),g=this.workspace.query.helper.getHierarchy(g),m;g&&g.levels.hasOwnProperty(f)&&(m=g.levels[f]);h.level&&void 0!==h.level.annotations&&null!==h.level.annotations&&
(void 0!==h.level.annotations.AnalyzerDateFormat||void 0!==h.level.annotations.SaikuDayFormatString)&&(_.has(m,"selection")&&0===m.selection.members.length||1===_.size(m)&&_.has(m,"name")||_.has(m,"mdx")&&m.mdx||2===_.size(m)&&_.has(m,"name")&&_.has(m,"mdx"))?(new DateFilterModal({dimension:d,hierarchy:e,target:c,name:c.attr("level"),data:h,analyzerDateFormat:h.level.annotations.AnalyzerDateFormat,dimHier:k,key:l,workspace:this.workspace})).open():(new SelectionsModal({target:c,name:c.text(),key:l,
workspace:this.workspace})).open();return!1},measure_action:function(a){if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;a=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent();var b=this.workspace.query,c=b.helper.model().queryModel.details,d={HEADER:{name:"Position",disabled:!0,i18n:!0},sep1:"---------",BOTTOM_COLUMNS:{name:"Columns | Measures",i18n:!0},TOP_COLUMNS:{name:"Measures | Columns",i18n:!0},BOTTOM_ROWS:{name:"Rows | Measures",
i18n:!0},TOP_ROWS:{name:"Measures | Rows",i18n:!0},sep2:"---------",reset:{name:"Reset Default",i18n:!0},cancel:{name:"Cancel",i18n:!0}};$.each(d,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});$.contextMenu("destroy",".limit");$.contextMenu({appendTo:a,selector:".limit",ignoreRightClick:!0,build:function(a,f){return{callback:function(a,d){if("cancel"!==a){if("reset"===a)c.location=SaikuOlapQueryTemplate.queryModel.details.location,c.axis=SaikuOlapQueryTemplate.queryModel.details.axis;
else{var e=a.split("_")[0],f=a.split("_")[1];c.location=e;c.axis=f}b.run()}},items:d}}});a.contextMenu()},limit_axis:function(a){var b=this;if("undefined"==typeof this.workspace.query||"QUERYMODEL"!=this.workspace.query.model.type||"view"==Settings.MODE)return!1;var c=$(a.target).hasClass("limit")?$(a.target):$(a.target).parent(),d=c.siblings(".fields_list_body").parent().attr("title");$.contextMenu("destroy",".limit");$.contextMenu({appendTo:c,selector:".limit",ignoreRightClick:!0,build:function(a,
f){var h=b.workspace.query,k={},l=Saiku.session.sessionworkspace.cube[b.workspace.selected_cube].get("data").measures,g=b.workspace.query.helper.getAxis(d),m=g.hierarchies,n,s,p,B,r,C,E,D,H,K=!1,A=!1,w=!1;g&&g.filters&&_.each(g.filters,function(a){"N"==a.flavour&&(n=g["function"],s=a.expressions[0],p=a.expressions[1],w=!0);"Generic"==a.flavour&&(B=a.expressions[0],K=!0)});g&&g.sortOrder&&(r=g.sortOrder,C=g.sortEvaluationLiteral,A=!0);g&&g.aggregators&&0<g.aggregators.length&&(H=g.aggregators[0]);
null!==n&&null===p?D=n+"###SEPARATOR###"+s:null!==n&&null!==p&&null!==s&&(D="custom");A&&null!==r&&(E="customsort");_.each(l,function(a){k[a.uniqueName]={name:a.caption,payload:{n:10,sortliteral:a.uniqueName}}});_.each(m,function(a){_.each(a.levels,function(b){k[a.name]={name:a.caption,payload:{n:10,sortliteral:a.name+".["+b.name+"].CURRENTMEMBER.ORDERKEY"}}})});_.each(g.hierarchies,function(a){for(var b in a.levels);});var m=function(a,b){var c={},d;for(d in a)c[b+"###SEPARATOR###"+d]=_.clone(a[d]),
c[b+"###SEPARATOR###"+d].fun=b,b==n&&p==d&&a[d].payload.n==s&&(D=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e"),b==r&&C==d&&(E=b+"Quick",c[b+"###SEPARATOR###"+d].name="\x3cb\x3e"+a[d].name+"\x3c/b\x3e");return c},x={filter:{name:"Filter",i18n:!0,items:{customfilter:{name:"Custom...",i18n:!0},clearfilter:{name:"Clear Filter",i18n:!0}}},limit:{name:"Limit",i18n:!0,items:{"TopCount###SEPARATOR###10":{name:"Top 10",i18n:!0},"BottomCount###SEPARATOR###10":{name:"Bottom 10",
i18n:!0},TopCountQuick:{name:"Top 10 by...",i18n:!0,items:m(k,"TopCount")},BottomCountQuick:{name:"Bottom 10 by...",i18n:!0,items:m(k,"BottomCount")},customtop:{name:"Custom Limit...",i18n:!0},clearlimit:{name:"Clear Limit",i18n:!0}}},sort:{name:"Sort",i18n:!0,items:{ASCQuick:{name:"Ascending",i18n:!0,items:m(k,"ASC")},DESCQuick:{name:"Descending",i18n:!0,items:m(k,"DESC")},BASCQuick:{name:"Ascending (Breaking Hierarchy)",i18n:!0,items:m(k,"BASC")},BDESCQuick:{name:"Descending (Breaking Hierarchy)",
i18n:!0,items:m(k,"BDESC")},customsort:{name:"Custom...",i18n:!0},clearsort:{name:"Clear Sort",i18n:!0}}},fold_totals:{name:"Totals",i18n:!0,items:{grand_totals:{name:"All",i18n:!0,items:{show_totals_not:{name:"None",i18n:!0},show_totals_sum:{name:"Sum",i18n:!0},show_totals_min:{name:"Min",i18n:!0},show_totals_max:{name:"Max",i18n:!0},show_totals_avg:{name:"Avg",i18n:!0}}}}},cancel:{name:"Cancel",i18n:!0}},I=h.helper.model().queryModel.details.measures;_.each(I,function(a){var c="fold_"+a.name.replace(/\s/g,
"_").toLowerCase(),d={name:a.name,items:{}};d.items["show_totals_nil_"+a.name]={name:b.formatAggregatorName("None","nil",g,a),i18n:!0};d.items["show_totals_sum_"+a.name]={name:b.formatAggregatorName("Sum","sum",g,a),i18n:!0};d.items["show_totals_min_"+a.name]={name:b.formatAggregatorName("Min","min",g,a),i18n:!0};d.items["show_totals_max_"+a.name]={name:b.formatAggregatorName("Max","max",g,a),i18n:!0};d.items["show_totals_avg_"+a.name]={name:b.formatAggregatorName("Avg","avg",g,a),i18n:!0};x.fold_totals.items[c]=
d});$.each(x,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});h=x.fold_totals.items.grand_totals.items;if(H)for(var M in h)M.substring(12)==H&&(h[M].name="\x3cb\x3e"+h[M].name+"\x3c/b");else h.show_totals_not.name="\x3cb\x3e"+h.show_totals_not.name+"\x3c/b";k["10"]={payload:{n:10}};K&&(H=x.filter,H.name="\x3cb\x3e"+H.name+"\x3c/b\x3e",H.items.customfilter.name="\x3cb\x3e"+H.items.customfilter.name+"\x3c/b\x3e");A&&(A=x.sort.items,x.sort.name="\x3cb\x3e"+x.sort.name+"\x3c/b\x3e",E in
A&&(A[E].name="\x3cb\x3e"+A[E].name+"\x3c/b\x3e"));w&&(A=x.limit.items,x.limit.name="\x3cb\x3e"+x.limit.name+"\x3c/b\x3e",D in A&&(A[D].name="\x3cb\x3e"+A[D].name+"\x3c/b\x3e"));return{callback:function(a,e){var f;if("cancel"!=a)if("clearfilter"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(g,"Generic"),b.synchronize_query(),b.workspace.query.run();else if("customfilter"==a)f=function(a){var c=[];c.push(a);b.workspace.query.helper.removeFilter(g,"Generic");g.filters.push({flavour:"Generic",
operator:null,"function":"Filter",expressions:c});b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:B,expressionType:"Filter",workspace:b.workspace})).render().open();else if("stringfilter"==a)f=function(a,c,d){c=[];c.push(a+('.CurrentMember.Name MATCHES ("(?i).*'+d+'.*")'));b.workspace.query.helper.removeFilter(g,"Generic");g.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:c});b.synchronize_query();b.workspace.query.run()},
(new StringFilterModal({axis:d,success:f,query:b.workspace.query,expression:B,expressionType:"Filter",workspace:b.workspace})).render().open();else if("clearlimit"==a)c.removeClass("on"),b.workspace.query.helper.removeFilter(g,"N"),b.synchronize_query(),b.workspace.query.run();else if("customtop"==a)f=function(a,c,d){var e=[];e.push(c);d&&e.push(d);b.workspace.query.helper.removeFilter(g,"N");g.filters.push({flavour:"N",operator:null,"function":a,expressions:e});b.synchronize_query();b.workspace.query.run()},
(new CustomFilterModal({axis:d,measures:l,success:f,query:b.workspace.query,func:n,n:s,sortliteral:p})).render().open();else if("customsort"==a)f=function(a,c){g.sortOrder=a;g.sortEvaluationLiteral=c;b.synchronize_query();b.workspace.query.run()},(new FilterModal({axis:d,success:f,query:b.workspace.query,expression:C,expressionType:"Order"})).render().open();else{if("clearsort"==a)g.sortOrder=null,g.sortEvaluationLiteral=null,b.synchronize_query();else if(0===a.indexOf("show_totals_")){var h=a.substring(12);
f=h.split("_");if(1<f.length){var h=f[0],m=a.substring(("show_totals_"+h).length+1);_.each(I,function(a){if(m===a.name){if(!a.aggregators)a.aggregators=[];else if(0<a.aggregators.length){for(var b=-1,c=0;c<a.aggregators.length;c++){var d=a.aggregators[c];if(0<d.indexOf("_")&&d.split("_")[1]==g.location){b=c;break}}0<=b&&a.aggregators.splice(b,1)}a.aggregators.push(h+"_"+g.location)}});g.aggregators&&0!=g.aggregators.length||(g.aggregators=[h])}else f=[],f.push(h),g.aggregators=f}else{f=a.split("###SEPARATOR###")[0];
var r=a.split("###SEPARATOR###")[1];if(-1<_.indexOf(["ASC","BASC","DESC","BDESC"],f))g.sortOrder=f,g.sortEvaluationLiteral=k[r].payload.sortliteral;else if(-1<_.indexOf(["Param"],f))g.sortEvaluationLiteral=k[r].payload.sortliteral;else{var D=[];D.push(k[r].payload.n);(r=k[r].payload.sortliteral)&&D.push(r);b.workspace.query.helper.removeFilter(g,"N");g.filters.push({flavour:"N",operator:null,"function":f,expressions:D})}b.synchronize_query()}b.workspace.query.run()}},items:x}}});c.contextMenu()},
formatAggregatorName:function(a,b,c,d){if(d.aggregators)for(var e=0;e<d.aggregators.length;e++){var f=d.aggregators[e].split("_"),h=f[1];if(b==f[0]&&h==c.location)return"\x3cb\x3e"+a+"\x3c/b\x3e"}return a}}),Table=Backbone.View.extend({className:"table_wrapper",events:{"click th.row":"clicked_cell","click th.col":"clicked_cell","click span.expander":"expand_row"},initialize:function(a){this.workspace=a.workspace;this.renderer=new SaikuTableRenderer;_.bindAll(this,"render","process_data","collapse",
"expand");this.workspace.bind("query:result",this.render);this.id=_.uniqueId("table_");$(this.el).attr("id",this.id)},expand_row:function(a){var b=$(a.currentTarget);b.hasClass("expanded")?this.collapse(a,b):this.expand(a,b);a.stopPropagation();a.preventDefault()},collapse:function(a,b){var c=$(a.currentTarget).parent(),d=c.parent().parent();b.html("\x26#9658;");b.removeClass("expanded");b.addClass("collapsed");var e=c.attr("rel").split(":"),f=parseInt(e[0]),e=parseInt(e[1]);this.workspace.query.result.lastresult();
var h=d.next();f++;var k=0<d.find("td[colspan],th[colspan]").length;this.workspace.toolbar.$el.find(".group_parents").hasClass("on");k?this.justCollapse(h,c):this.collapseAndHide(d,h,f,e)},justCollapse:function(a,b){for(var c=!0,d=b.parent().children().index(b);c;)$(a.find("th,td")[d]).hasClass("row_null")?(a.hide(),a=a.next()):c=!1},collapseAndHide:function(a,b,c,d){for(var e=!0,f=a.find("th, td"),h=d+1;h<f.length;h++)$(f[h]).find("div").hide();for(;e;)if(0<b.length){f=b.find("th,td");if(0<f.length&&
$(f[d]).hasClass("row_total_corner")){e=a.find("div.datadiv");f=b.find("td.data");for(h=0;h<e.length;h++){var k='\x3cspan class\x3d"totalSpan"\x3e'+$(f[h]).html()+"\x3c/span\x3e";$(e[h]).parent().addClass("total");$(e[h]).parent().html($(e[h]).wrap("\x3cp/\x3e").parent().html()+k)}b.hide();break}else{for(h=0;h<=d;h++){for(var f=b.find("th,td"),k=!1,l=0;l<d&&l<f.length;l++)$(f[l]).hasClass("row_total_corner")&&(k=!0,e=!1);if(c<this.workspace.query.result.lastresult().cellset.length&&this.workspace.query.result.lastresult().cellset[c][h].value!=
this.workspace.query.result.lastresult().cellset[c-1][h].value&&!k){for(h=null;0!=b.find(".row_total_corner").length;)b.hide(),h=b,b=b.next();if(null!=h)for(e=a.find("div.datadiv"),f=h.find("td.data"),h=0;h<e.length;h++)k='\x3cspan class\x3d"totalSpan"\x3e'+$(f[h]).html()+"\x3c/span\x3e",$(e[h]).parent().addClass("total"),$(e[h]).parent().html($(e[h]).wrap("\x3cp/\x3e").parent().html()+k);e=!1;break}}if(!e)break}0==b.find(".row_total_corner").length&&c++;b.hide();b=b.next()}else break},expand:function(a,
b,c,d){c=$(a.currentTarget).parent();d=c.attr("rel").split(":");parseInt(d[0]);d=parseInt(d[1]);b.html("\x26#9660;");b.removeClass("collapsed");b.addClass("expanded");c=$(a.currentTarget).parent();a=c.parent().parent();b=a.find("th, td");for(c=0;c<b.length;c++){var e=$(b[c]).find("div");0<e.length&&$(e).show();a.find(".total").removeClass("total");a.find(".totalSpan").remove()}a.find("span.collapsed").removeClass("collapsed").addClass("expanded").html("\x26#9660;");for(a=a.next();0<a.length&&($(a.find("th,td")[d]).hasClass("row_null")||
$(a.find("th,td")[d]).hasClass("row_total_corner"));){a.find("span.collapsed").removeClass("collapsed").addClass("expanded").html("\x26#9660;");a.find(".totalSpan").remove();a.find("div:hidden").show();if("none"==a.css("display"))a.show();else break;a=a.next()}},clicked_cell:function(a){var b=this;0<$(this.workspace.el).find(".workspace_results.ui-selectable").length&&$(this.workspace.el).find(".workspace_results").selectable("destroy");a=$(a.target).hasClass("row")||$(a.target).hasClass("col")?$(a.target).find("div"):
$(a.target);$(document);$.contextMenu("destroy",".row, .col");$.contextMenu({appendTo:a,selector:".row, .col",ignoreRightClick:!0,build:function(a,d){var e=$(d.currentTarget).find("div"),f=$(d.currentTarget).hasClass("row")?"ROWS":"COLUMNS",h=e.attr("rel").split(":"),k=parseInt(h[0]),h=parseInt(h[1]),l=b.workspace.query.result.lastresult().cellset[k][h],k=b.workspace.query;k.get("schema");k.get("connection");k.get("catalog");k.get("cube");var g=l.properties.dimension,m=l.properties.hierarchy,n=l.properties.level,
s="",p="",B=JSON.stringify({hierarchy:m,uniquename:n,type:"level",action:"delete"})+","+JSON.stringify({hierarchy:m,uniquename:l.properties.uniquename,type:"member",action:"add"}),k=l.properties.uniquename,r={},h=b.workspace.selected_cube,C;Saiku.session.sessionworkspace.cube[h]&&C&&measures||("undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+h)?Saiku.session.sessionworkspace.cube[h]=new Cube(JSON.parse(localStorage.getItem("cube."+h))):(Saiku.session.sessionworkspace.cube[h]=
new Cube({key:h}),Saiku.session.sessionworkspace.cube[h].fetch({async:!1})),C=Saiku.session.sessionworkspace.cube[h].get("data").dimensions);var E=[];(h=b.workspace.query.helper.getHierarchy(m))&&_.each(h.levels,function(a){E.push(m+".["+a.name+"]")});_.each(C,function(a){a.name==g&&_.each(a.hierarchies,function(a){a.uniqueName==m&&_.each(a.levels,function(a){r[a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"add"})};-1<_.indexOf(E,a.uniqueName)&&
(r[a.name].disabled=!0,r["remove-"+a.name]={name:a.caption,payload:JSON.stringify({hierarchy:m,uniquename:a.uniqueName,type:"level",action:"delete"})});a.uniqueName==n&&(s=a.caption,p=a.name);r["keep-"+a.name]=r[a.name];r["include-"+a.name]=JSON.parse(JSON.stringify(r[a.name]));r["keep-"+a.name].payload=B+","+r[a.name].payload})})});r.keeponly={payload:B};r.getchildren={payload:k};r.hasOwnProperty("remove-"+p)&&r.hasOwnProperty("include-"+p)&&(r.showall={payload:r["remove-"+p].payload+", "+r["include-"+
p].payload});C=function(a){var b={},c;for(c in r)null!==a&&a.length<c.length&&c.substr(0,a.length)==a&&(b[c]=r[c]);return b};k={name:{name:"\x3cb\x3e"+e.html()+"\x3c/b\x3e",disabled:!0},sep1:"---------",keeponly:{name:"Keep Only",i18n:!0,payload:B}};"Measures"!=g&&(k.fold1key={name:"Include Level",i18n:!0,items:C("include-")},k.fold2key={name:"Keep and Include Level",i18n:!0,items:C("keep-")},k.fold3key={name:"Remove Level",i18n:!0,items:C("remove-")},k.filterlevel={name:"Filter Level",i18n:!0});
$.each(k,function(a,b){recursive_menu_translate(b,Saiku.i18n.po_file)});return{callback:function(a,c){var d=[];if("keeponly"===a){var g=b.workspace.query.helper.getHierarchy(m);if(g&&g.levels.hasOwnProperty(p)||"[Measures]"==m)"[Measures]"==m?(d={caption:l.value,name:l.value,type:"EXACT",uniqueName:l.properties.uniquename},b.workspace.query.helper.clearMeasures(),b.workspace.query.helper.includeMeasure(d),b.workspace.sync_query(),b.workspace.query.run()):(d.push({uniqueName:l.properties.uniquename,
caption:l.properties.uniquename}),g.levels[p].selection={type:"INCLUSION",members:d},b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))}else if("filterlevel"===a)d=l.properties.level.substring(l.properties.level.lastIndexOf(".")+1),d=d.replace("[","").replace("]",""),(new SelectionsModal({target:e,name:"Filter Level",key:l.properties.hierarchy+"/"+d,workspace:b.workspace,axis:"ROWS"})).open();else if("remove"===a.substring(0,a.indexOf("-"))){var h=a.substring(a.indexOf("-")+1);
Settings.ALLOW_PARAMETERS&&(b.workspace.query.helper.removeParameter(m,h),b.workspace.$el.find(".parameter_input").empty());b.workspace.query.helper.removeLevel(m,h);b.workspace.drop_zones.synchronize_query();b.workspace.query.run(!0)}else"keep"===a.substring(0,a.indexOf("-"))?(h=a.substring(a.indexOf("-")+1),(g=b.workspace.query.helper.getHierarchy(m))&&g.levels.hasOwnProperty(s)&&(d.push({uniqueName:l.properties.uniquename,caption:l.properties.uniquename}),g.levels[s].selection={type:"INCLUSION",
members:d},b.workspace.query.helper.includeLevel(f,m,h,null),b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))):"include"===a.substring(0,a.indexOf("-"))&&(h=a.substring(a.indexOf("-")+1),b.workspace.query.helper.includeLevel(f,m,h,null),b.workspace.drop_zones.synchronize_query(),b.workspace.query.run(!0))},items:k}}});a.contextMenu()},render:function(a,b){"undefined"==typeof a||"undefined"==typeof a.data||$(this.workspace.el).is(":visible")&&!$(this.el).is(":visible")||null!==
a.data&&null!==a.data.error||null===a.data||a.data.height&&0===a.data.height||(this.clearOut(),$(this.el).html("Rendering "+a.data.width+" columns and "+a.data.height+" rows..."),_.delay(this.process_data,2,a.data))},clearOut:function(){this.renderer.clear();$(this.workspace.el).find(".workspace_results").unbind("scroll");var a=document.getElementById(this.id);null==a&&(this.workspace.tab.select(),a=document.getElementById(this.id));var b=a.firstChild;b&&a.removeChild(b)},process_data:function(a){var b=
Settings.HIDE_EMPTY_ROWS&&this.workspace.query.getProperty("saiku.olap.query.nonempty");this.workspace.processing.hide();this.workspace.adjust();this.clearOut();$(this.el).html("\x3ctable\x3e\x3c/table\x3e");this.renderer.render(a,{hideEmpty:b,htmlObject:$(this.el).find("table"),batch:Settings.TABLE_LAZY,batchSize:Settings.TABLE_LAZY_SIZE,batchIntervalSize:Settings.TABLE_LAZY_LOAD_ITEMS,batchIntervalTime:Settings.TABLE_LAZY_LOAD_TIME});this.post_process()},post_process:function(){"QM"==this.workspace.query.get("type")&&
"view"!=Settings.MODE?$(this.el).addClass("headerhighlight"):$(this.el).removeClass("headerhighlight");$(this.el).find(".i18n").i18n(Saiku.i18n.po_file);this.workspace.trigger("table:rendered",this)}}),Workspace=Backbone.View.extend({className:"tab_container",events:{"click .sidebar_separator":"toggle_sidebar","change .cubes":"new_query","drop .sidebar":"remove_dimension","drop .workspace_results":"remove_dimension","click .refresh_cubes":"refresh","click .cancel":"cancel","click .admin":"admin"},
initialize:function(a){_.bindAll(this,"caption","adjust","adjust_trigger","toggle_sidebar","prepare","new_query","set_class_charteditor","init_query","update_caption","populate_selections","refresh","sync_query","cancel","cancelled","no_results","error","switch_view_state");_.extend(this,Backbone.Events);this.loaded=!1;this.bind("query:result",this.render_result);this.toolbar=new WorkspaceToolbar({workspace:this});this.toolbar.render();this.upgrade=new Upgrade({workspace:this});this.upgrade.render();
this.querytoolbar=new QueryToolbar({workspace:this});this.querytoolbar.render();this.drop_zones=new WorkspaceDropZone({workspace:this});this.drop_zones.render();this.table=new Table({workspace:this});this.chart=new Chart({workspace:this});this.dateFilter=new DateFilterCollection;this.item={};this.viewState=a&&a.viewState?a.viewState:Settings.DEFAULT_VIEW_STATE;this.isReadOnly="view"==Settings.MODE||!1;a&&a.item&&(this.item=a.item)&&this.item.hasOwnProperty("acl")&&0>_.indexOf(this.item.acl,"WRITE")&&
(this.isReadOnly=!0,this.viewState="view");a&&(a.query||a.viewState)||(this.viewState="edit");a&&a.query&&(this.query=a.query,this.query.workspace=this,this.query.save({},{success:this.init_query,error:function(){Saiku.ui.unblock();if(1>$("body").find(".error_loading_query").length){var a=Saiku.i18n&&Saiku.i18n.po_file.error_loading_query?Saiku.i18n.po_file.error_loading_query:null;a||($('\x3cspan class\x3d"i18n error_loading_query"\x3eError Loading Query\x3c/span\x3e').hide().appendTo("body"),Saiku.i18n.translate(),
a=$(".error_loading_query").text())}else a=$(".error_loading_query").text();alert(a)}}));Saiku.session.bind("tab:add",this.prepare);var b=Saiku.URLParams.paramsURI();void 0!==a&&void 0!==a.processURI&&!1===a.processURI&&(b={});Saiku.URLParams.contains({schema:b.schema,cube:b.cube});this.data_connections(b)},afterRender:function(){},caption:function(a){if(this.query&&this.query.model){if(this.item&&this.item.name)return this.item.name.split(".")[0];if(this.query.model.mdx)return this.query.model.name}else if(this.query&&
...
for(var b=a.selected_cube.split("/"),c=b[3],d=4,e=b.length;d<e;d++)c+="/"+b[d];Saiku.events.trigger("workspace:new_query",this,{view:this,cube:c});this.query=new Query({cube:{connection:b[0],catalog:b[1],schema:"null"==b[2]?"":b[2],name:decodeURIComponent(c)}},{workspace:a});this.processedParamsURI||(b=Saiku.URLParams.paramsURI(),c=function(a,b){var c=this.query.helper.getAxis(a),d=b.charAt(0),e=b.charAt(b.length-1),m=[],n=[],s="";if("("===d&&")"===e)if(b=Saiku.trimFirstLastChar(b),-1!==b.indexOf("],")){for(var n=
b.split("],")[0].split("].["),d=_.last(n),n=_.first(n,2<n.length?2:1),e=b.split("],")[1].trim(),p=0,B=n.length;p<B;p++)s+="["+Saiku.removeBrackets(n[p])+"].";s=Saiku.trimFirstLastChar(s,"last");this.query.helper.includeLevel(a,s,d,"-1")}else e=b;else e=b;m.push(e);this.query.helper.removeFilter(c,"Generic");c.filters.push({flavour:"Generic",operator:null,"function":"Filter",expressions:m})}.bind(this),Saiku.URLParams.contains({default_mdx_filter_rows:b.default_mdx_filter_rows})&&c("ROWS",b.default_mdx_filter_rows),
Saiku.URLParams.contains({default_mdx_filter_columns:b.default_mdx_filter_columns})&&c("COLUMNS",b.default_mdx_filter_columns),Saiku.URLParams.contains({default_mdx_filter:b.default_mdx_filter})&&c("FILTER",b.default_mdx_filter),this.processedParamsURI=!0);a.query=this.query;a.query.save({},{data:{json:JSON.stringify(this.query.model)},async:!1});a.init_query()},extractDefaultFilters:function(a){var b=[],c,d;for(d in a)if(-1<d.indexOf("default_filter_")){var e=d.replace("default_filter_","");c=a[d];
b.push({filtername:e,filtervalue:c})}return b},new_query:function(){this.query?Settings.QUERY_OVERWRITE_WARNING?(new WarningModal({title:"New Query",message:"You are about to clear your existing query",okay:this.create_new_query,okayobj:this,cancel:this.cancel_new_query,cancelobj:this})).render().open():this.create_new_query(this):this.create_new_query(this)},cancel_new_query:function(a){a.$el.find('#cubesselect option[value\x3d"'+a.selected_cube+'"]').prop("selected",!0)},init_query:function(a){var b=
...
$(this.querytoolbar.el).find('ul.chart [href\x3d"#charteditor"]').addClass("on")},synchronize_query:function(){this.isReadOnly||Settings.hasOwnProperty("MODE")},sync_query:function(a){if("QUERYMODEL"===this.query.helper.model().type&&(a=null!=this.dimension_list?a?a:$(this.dimension_list.el):a?a:null,!this.isReadOnly&&(!Settings.hasOwnProperty("MODE")||"table"!=Settings.MODE&&"view"!=Settings.MODE))){a.find(".selected").removeClass("selected");var b=this.query.helper.getCalculatedMeasures();b&&0<
b.length?(b=_.template($("#template-calculated-measures").html(),{measures:b}),a.find(".calculated_measures").html(b),a.find(".calculated_measures").find(".measure").parent("li").draggable({cancel:".not-draggable",connectToSortable:$(this.el).find(".fields_list_body.details ul.connectable"),helper:"clone",placeholder:"placeholder",opacity:.6,tolerance:"touch",containment:$(this.el),cursorAt:{top:10,left:35}})):a.find(".calculated_measures").empty();this.drop_zones.synchronize_query()}Saiku.i18n.translate()},
populate_selections:function(a){a.workspace.sync_query();return!1},update_caption:function(a){a=this.caption(a);this.tab.set_caption(a)},remove_dimension:function(a,b){"QUERYMODEL"==this.query.model.type&&this.drop_zones.remove_dimension(a,b)},update_parameters:function(){var a=this;$(this.el).find(".parameter_input").html("");if(a.hasOwnProperty("query")&&Settings.ALLOW_PARAMETERS&&"view"!==Settings.MODE&&"view"!==a.viewState){var b="\x3cspan class\x3d'i18n'\x3eParameters\x3c/span\x3e: ",c=this.query.helper.model().parameters,
d=!1,e;for(e in c){var f="",h;c[e]&&null!==c[e]&&(f=c[e],h=c[e].split(","));void 0!=f&&""!=f&&(f+=",");d=this.query.helper.getSelectionsForParameter(e);_.each(d,function(a){-1<$.inArray(a.name,h)||(f=f+a.name+",")});var f=f.substr(0,f.lastIndexOf(",")),b=b+("\x3cb\x3e"+e+"\x3c/b\x3e \x3cinput type\x3d'text' placeholder\x3d'"+e+"' value\x3d'"+f+"' /\x3e"),d=!0,k=f.split(","),l=a.query.helper.getLevelForParameter(e);_.each(k,function(b){void 0!=b&&""!=b&&a.query.helper.addtoSelection(b,l)})}b+="";d?
...
try{var d=a.split("/");if(1<d.length){var e=d.splice(0,d.length-1).join("/"),f=this.queries[e];"undefined"!=typeof f.acl&&-1<_.indexOf(f.acl,"WRITE")&&$(this.el).find(".add_folder").parent().removeClass("hide")}else 1==d.length&&$(this.el).find(".add_folder").parent().removeClass("hide")}catch(h){}var d=$(this.el).find(".workspace_results").html("\x3ch3\x3e\x3cstrong\x3e"+c.name+"\x3c/strong\x3e\x3c/h3\x3e"),d=$('\x3cul id\x3d"query_info" /\x3e').appendTo(d),k;for(k in c)c.hasOwnProperty(k)&&"name"!=
k&&d.append($("\x3cli /\x3e").html("\x3cstrong\x3e"+k+"\x3c/strong\x3e : "+c[k]));this.selected_query=new SavedQuery({file:a,name:b,type:c.type});return!1},view_folder:function(a){var b=$(a.currentTarget).children("div").children("a");a=b.attr("href").replace("#","");var b=b.text(),c=this.queries[a];$(this.el).find(".workspace_toolbar").removeClass("hide");$(this.el).find(".add_folder").parent().addClass("hide");$(this.el).find(".for_queries").addClass("hide");$(this.el).find(".for_folder").addClass("hide");
...
closeText:"Save",events:{click:"select_root_folder","click .dialog_footer a":"call","submit form":"save","click .query":"select_name","click li.folder":"toggle_folder","keyup .search_file":"search_file","click .cancel_search":"cancel_search"},buttons:[{text:"Save",method:"save"},{text:"Cancel",method:"close"}],folder_name:null,file_name:null,initialize:function(a){var b=this,c="",d="";if(a.query.name){var e;a.query.name=a.query.name.replace(/:/g,"/");e=a.query.name.split("/");d=a.query.name;this.file_name=
c=e[e.length-1];1<e.length&&(this.folder_name=e.splice(0,e.length-1).join("/"))}this.query=a.query;this.message=_.template('\x3cform id\x3d"save_query_form"\x3e\x3cdiv class\x3d"form-inline box-search-file" style\x3d"height: 35px; padding-top: 10px; line-height: 25px;"\x3e\x3clabel class\x3d"i18n"\x3eSearch:\x3c/label\x3e \x26nbsp; \x3cinput type\x3d"text" class\x3d"form-control search_file"\x3e\x3c/input\x3e\x3cspan class\x3d"cancel_search"\x3e\x3c/span\x3e\x3c/div\x3e\x3cdiv class\x3d"RepositoryObjects"\x3e\x3cspan class\x3d"i18n"\x3eLoading...\x3c/span\x3e\x3c/div\x3e\x3cdiv class\x3d"form-inline" style\x3d"padding-top: 4px;"\x3e\x3clabel for\x3d"name" class\x3d"i18n"\x3eFile:\x3c/label\x3e\x26nbsp;\x3cinput type\x3d"text" name\x3d"name" id\x3d"relative-file-path" class\x3d"form-control" value\x3d"\x3c%\x3d name %\x3e"\x3e\x3c/div\x3e\x3cbr\x3e\x3c/form\x3e')({name:d});
_.extend(this.options,{title:"Save query"});this.repository=new Repository({},{dialog:this,type:"saiku"});this.bind("open",function(){var a=$("body").height()/2+$("body").height()/6;420<a&&(a=420);var c=($("body").height()-600)/2*100/$("body").height();b.$el.find(".RepositoryObjects").height(a);b.$el.dialog("option","position","center");b.$el.parents(".ui-dialog").css({width:"550px",top:c+"%"});b.repository.fetch();Settings.REPOSITORY_LAZY&&b.$el.find(".box-search-file").hide()});_.bindAll(this,"copy_to_repository",
"close","toggle_folder","select_name","populate","set_name","cancel_search");if(isIE&&9>isIE)$(this.el).find("form").on("submit",this.save)},populate:function(a){this.$el.find(".RepositoryObjects").html(_.template($("#template-repository-objects").html())({repoObjects:a}));this.context_menu_disabled();this.select_last_location()},context_menu_disabled:function(){this.$el.find(".RepositoryObjects").find(".folder_row, .query").addClass("context-menu-disabled")},select_root_folder:function(a){"name"!==
$(a.target).attr("name")&&this.unselect_current_selected_folder()},toggle_folder:function(a){a=$(a.currentTarget);var b=a.children(".folder_row").find("a").attr("href"),c,b=b.replace("#","");this.unselect_current_selected_folder();a.children(".folder_row").addClass("selected");c=a.find("a").attr("href").replace("#","");this.set_name(c,null);c=a.children(".folder_content");a.children(".folder_row").find(".sprite").hasClass("collapsed")?(a.children(".folder_row").find(".sprite").removeClass("collapsed"),
...
a.append(_.template($("#template-repository-folder-lazyload").html())({repoObjects:b}))},populate_lazyload:function(a,b){Saiku.ui.unblock();this.template_repository_folder_lazyload(a,b)},set_name:function(a,b){if(null!==a){var c;this.folder_name=a;c=(null!==this.folder_name?this.folder_name+"/":"")+(null!==this.file_name?this.file_name:"");this.$el.find('input[name\x3d"name"]').val(c)}null!==b&&this.$el.find('input[name\x3d"name"]').val(b)},search_file:function(a){var b=this.$el.find(".search_file").val().toLowerCase();
...
_.extend(this.options,{title:"Open"});this.selected_folder=null;this.repository=new Repository({},{dialog:this,type:"saiku"});this.bind("open",function(){var a=$("body").height()/2+$("body").height()/6;420<a&&(a=420);var d=($("body").height()-600)/2*100/$("body").height();$(this.el).find(".RepositoryObjects").height(a);$(this.el).dialog("option","position","center");$(this.el).parents(".ui-dialog").css({width:"550px",top:d+"%"});$(this.el).find(".dialog_footer").find('a[href\x3d"#open_query"]').hide();
...
this.result=new Result({limit:Settings.RESULT_LIMIT},{query:this});this.scenario=new QueryScenario({},{query:this});this.updatedSelectionFromModal=!1},parse:function(a){this.id=this.uuid;a.name&&(this.uuid=this.id=a.name);this.model=_.extend(this.model,a);this.model.properties=_.extend({},Settings.QUERY_PROPERTIES,this.model.properties)},setProperty:function(a,b){this.model.properties[a]=b},getProperty:function(a){return this.model.properties[a]},syncSelectionsModalAndUpdateParameters:function(){if(this.updatedSelectionFromModal){var a=
this.helper.model().parameters,b;for(b in a){var c=a[b],d=this.helper.getSelectionsForParameter(b),c=d.map(function(a){return a.caption}).join();a[b]=c}}else for(b in a=this.helper.model().parameters,a)c=a[b],this.helper.getLevelForParameter(b),d=this.helper.getSelectionsForParameter(b),null!==c&&void 0!==c&&this.helper.setSelectionsForParameter(b,_.filter(d,function(a){var b=!1;_.each(c.split(","),function(c){if(a.caption===c)return b=!0,!1});return b}));this.updatedSelectionFromModal=!1},run:function(a,
b){this.syncSelectionsModalAndUpdateParameters();var c=this;Saiku.ui.unblock();if("undefined"==typeof this.model.properties||!1!==this.model.properties["saiku.olap.query.automatic_execution"]||!1!==a&&void 0!==a&&null!==a){this.workspace.unblock();$(this.workspace.el).find(".workspace_results_info").empty();this.workspace.trigger("query:run");this.result.result=null;var d=!1,e='\x3cspan class\x3d"i18n"\x3eQuery Validation failed!\x3c/span\x3e',f=this.helper.model(),h;for(h in this.attributes){var k=
this.attributes[h];if("PARAM"===h.substring(0,5)){var l=h.substring(5,h.length);f.parameters[l]=k}}"OLAP"==f.queryType&&("QUERYMODEL"==f.type?(h=0<Object.keys(f.queryModel.axes.COLUMNS.hierarchies).length,k=0<Object.keys(f.queryModel.axes.ROWS.hierarchies).length,l="COLUMNS"==f.queryModel.details.axis&&0<f.queryModel.details.measures.length,k&&h&&l||(e=""),h||l||(e+='\x3cspan class\x3d"i18n"\x3eYou need to include at least one measure or a level on columns for a valid query.\x3c/span\x3e'),k||(e+=
'\x3cspan class\x3d"i18n"\x3eYou need to include at least one level on rows for a valid query.\x3c/span\x3e'),(h||l)&&k&&(d=!0)):"MDX"==f.type&&((d=f.mdx&&0<f.mdx.length)||(e='\x3cspan class\x3d"i18n"\x3eYou need to enter some MDX statement to execute.\x3c/span\x3e')));d?(this.workspace.table.clearOut(),$(this.workspace.processing).html('\x3cspan class\x3d"processing_image"\x3e\x26nbsp;\x26nbsp;\x3c/span\x3e \x3cspan class\x3d"i18n"\x3eRunning query...\x3c/span\x3e [\x26nbsp;\x3ca class\x3d"cancel i18n" href\x3d"#cancel"\x3eCancel\x3c/a\x3e\x26nbsp;]').show(),
...
SessionErrorModal=Modal.extend({initialize:function(a,b){_.extend(this.options,{title:"Error"});this.reportedissue=a.issue;this.message="There has been an error creating a session:\x3cbr\x3e"+this.reportedissue},events:{"click a":"close"},dummy:function(){return!0},type:"info"}),SplashScreen=Backbone.View.extend({events:{"click .run_query":"run_query","click .run_dashboards":"run_dashboard","click .head":"click_head","click .beg_tut":"run_tour"},template:_.template('\x3cdiv id\x3d"splash"\x3e\x3cnav\x3e\x3cul\x3e\x3cli class\x3d"active"\x3e\x3ca class\x3d"welcome head" href\x3d"#"\x3eWelcome\x3c/a\x3e\x3c/li\x3e\x3cli\x3e\x3ca class\x3d"features head" href\x3d"#"\x3eFeatures\x3c/a\x3e\x3c/li\x3e\x3cli\x3e\x3ca class\x3d"help head" href\x3d"#"\x3eGet Help\x3c/a\x3e\x3c/li\x3e\x3cli class\x3d"enterprisetoggle enterprise"\x3e\x3ca class\x3d"enterprise head" href\x3d"#"\x3eEnterprise\x3c/a\x3e\x3c/li\x3e\x3c/ul\x3e\x3ch2\x3eExplore Data. Visualise. Act.\x3c/h2\x3e\x3c/nav\x3e\x3csection class\x3d"stabs"\x3e\x3csection style\x3d"margin-top: 50px; min-height: 700px;" id\x3d"welcome"\x3e\x3cdiv style\x3d"width: 50%; float: left;"\x3e\x3ch1 class\x3d"saikulogo"\x3eSaiku\x3c/h1\x3e\x3cp\x3eSaiku has the power to change the way you think about your business and make decisions. Saiku provides powerful, web based analytics for everyone in your organisation. Quickly and easily analyse data from any data source to discover what is really happening inside and outside your organisation. \x3ci class\x3d"icon icon-remove" style\x3d"height: 100px;"\x3e\x3c/i\x3e\x3c/p\x3e\x3ch2\x3eQuick Links\x3c/h2\x3e\x3cul class\x3d"quicklinks"\x3e\x3cli\x3e\x3ca class\x3d"run_query" href\x3d"#"\x3eCreate a new query\x3c/a\x3e\x3c/li\x3e\x3cli\x3e\x3ca class\x3d"run_dashboards" href\x3d"#"\x3eCreate a dashboard\x3c/a\x3e\x3c/li\x3e\x3cli\x3e \x3ca href\x3d"http://www.meteorite.bi/products/saiku" target\x3d"_blank"\x3eVisit the website\x3c/a\x3e\x3c/li\x3e\x3cli\x3e\x3ca class\x3d"help head" href\x3d"#"\x3eTutorials\x3c/a\x3e\x3c/li\x3e\x3c/ul\x3e\x3cp class\x3d"fixed"\x3e\x3ca class\x3d"enterprisetoggle button" href\x3d"http://meteorite.bi" target\x3d"_blank"\x3eGet Enterprise\x3c/a\x3e\x3c/p\x3e\x3c/div\x3e\x3cdiv style\x3d"width: 40%; margin-left: 10%; float: left;" id\x3d"dyn_content" class\x3d"enterprisetoggle"\x3e\x3ch2\x3eDiscover more about Saiku\x3c/h2\x3e\x3cp style\x3d"margin-bottom: 10px;"\x3eSaiku Analytics provides both a Community Version and an Enterprise Version with added features. To find out more you can \x3ca href\x3d"http://meteorite.bi" target\x3d"_blank"\x3evisit our website\x3c/a\x3e or watch the videos on our \x3ca href\x3d"https://www.youtube.com/channel/UChivLeroOJx0_JamfuZ_XHA" target\x3d"_blank"\x3eYoutube channel\x3c/a\x3e.\x3c/p\x3e\x3cp\x3eIf you are using Saiku Analytics in a business or commercial product, you can help give back in many ways. Swing by our \x3ca href\x3d"http://webchat.freenode.net/?channels\x3d##saiku" target\x3d"_blank"\x3eIRC channel\x3c/a\x3e and help foster the community, join the \x3ca href\x3d"http://community.meteorite.bi" target\x3d"_blank"\x3emailing lists\x3c/a\x3e and ask/answer questions, \x3ca href\x3d"http://meteorite.bi" target\x3d"_blank"\x3esponsor a new feature\x3c/a\x3e, or best of all \x3ca href\x3d"http://www.meteorite.bi/saiku-pricing" target\x3d"_blank"\x3epurchase an EE license\x3c/a\x3e, which funds development of Saiku Community Edition along with Enterprise Edition.\x3c/p\x3e\x3c/div\x3e\x3c/section\x3e\x3csection style\x3d"display: none !important; margin-top: 50px;" id\x3d"features"\x3e\x3ch1 class\x3d"saikulogo"\x3eSaiku\x3c/h1\x3e\x3ch2\x3eFeatures\x3c/h2\x3e\x3ch3\x3eWeb Based Analysis\x3c/h3\x3e\x3cp\x3eSaiku provides the user with an entirely browser based experience. We support all modern browsers, and our user interface is 100% HTML and Javascript.\x3cbr/\x3e\x3cbr/\x3eSaiku uses REST based communications, this allows the development of custom user interfaces and facilitates the easy integration of the Saiku Server into other applications and services.\x3c/p\x3e\x3ch3\x3eStandards Compliant\x3c/h3\x3e\x3cp\x3eSaiku is based upon the Microsoft MDX query language and will work on most JDBC compliant data sources. We also provide a number of connectors to NOSQL data sources.\x3c/p\x3e\x3ch3\x3eDynamic charting\x3c/h3\x3e\x3cp\x3eSaiku uses a flexible charting engine to provide a wide range of charts and graphs. These are all HTML \x26 Javascript only and don\'t require flash to be installed on the computer.\x3c/p\x3e\x3ch3\x3ePluggable visualisation engine\x3c/h3\x3e\x3cp\x3eSaiku Enterprise boasts a fully pluggable visualisation engine. This allows developers to build third party extensions and plug them into Saiku Enterprise to extend or replace the existing visualisations.\x3c/p\x3e\x3c/section\x3e\x3csection style\x3d"display: none !important; margin-top: 50px;" id\x3d"help"\x3e\x3ch1 class\x3d"saikulogo"\x3eSaiku\x3c/h1\x3e\x3ch2\x3eHelp\x3c/h2\x3e\x3cp\x3eWe provide Training, Consulting and Support to ensure you get the most from Saiku and your data. Our services cover all aspects of data analysis including data strategy, design, architecture, deployment and application/software support.\x3c/p\x3e\x3ctable style\x3d"margin-bottom: 100px;"\x3e\x3ctr\x3e\x3cth\x3eTutorials\x3c/th\x3e\x3cth\x3eDocs\x3c/th\x3e\x3cth\x3eSupport\x3c/th\x3e\x3c/tr\x3e\x3ctr\x3e\x3ctd\x3eWe have a number of click through tutorials to help get your started:\x3cul style\x3d"list-style: none;"\x3e\x3cli\x3e\x3ca class\x3d"beg_tut" href\x3d"#"\x3eBeginners (Query building and charts)\x3c/a\x3e\x3c/li\x3e\x3c/ul\x3e\x3c/td\x3e\x3ctd\x3eWhy not try  our new \x3ca href\x3d"http://saiku-documentation.readthedocs.io/en/latest/" target\x3d"_blank"\x3eDocumentation site\x3c/a\x3e\x3cbr/\x3efor community documentation.\x3c/td\x3e\x3ctd\x3eIf you require more, \x3cbr/\x3e\x3ca href\x3d"mailto:info@meteorite.bi"\x3econtact us\x3c/a\x3e for support.\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e\x3c/section\x3e\x3csection style\x3d"display: none !important; margin-top: 50px;" id\x3d"enterprise"\x3e\x3ch1 class\x3d"saikulogo"\x3eSaiku\x3c/h1\x3e\x3ch2\x3eEnterprise\x3c/h2\x3e\x3cp\x3eSaiku Enterprise is our fully supported and tested server and Pentaho plugin system. Buy Saiku Enterprise from as little as $15 per user per month and enjoy the addtional features Saiku Enterprise has to offer!\x3c/p\x3e\x3cp\x3eTo find out more visit our \x3ca href\x3d"http://meteorite.bi" target\x3d"_blank"\x3esite\x3c/a\x3e or \x3ca href\x3d"mailto:info@meteorite.bi"\x3eschedule a call\x3c/a\x3e with one of us and we can show you why you should choose Saiku Enterprise!\x3c/p\x3e\x3c/section\x3e\x3c/section\x3e\x3c/div\x3e'),
initialize:function(a){_.bindAll(this,"caption");_.extend(this,Backbone.Events)},caption:function(){return'\x3cspan class\x3d"i18n"\x3eHome\x3c/span\x3e'},render:function(){this.$el.html(this.template());Settings.LICENSE&&void 0!==Settings.LICENSE.licenseType&&"trial"!==Settings.LICENSE.licenseType&&"Open Source License"!==Settings.LICENSE.licenseType&&this.hide_content_enterprise();this.get_content();this.setup_page();$("#splash \x3e nav \x3e ul \x3e li.active \x3e a").click(function(){var a=$(this).attr("class");
$("nav li").removeClass("active");$(this).parent().addClass("active");$(".stabs section").hide();$("#"+a).fadeIn()});return this},click_head:function(a){a.preventDefault();a=a.target;var b=$(a).attr("class").split(" "),c="";$("nav li").removeClass("active");$(a).parent().addClass("active");$(".stabs section").hide();-1<b.indexOf("welcome")?c="welcome":-1<b.indexOf("features")?c="features":-1<b.indexOf("help")?c="help":-1<b.indexOf("enterprise")&&(c="enterprise");$("#"+c).fadeIn()},run_tour:function(){this.toolbar=
Saiku.toolbar;(new Tour({toolbar:this.toolbar})).run_tour()},run_query:function(){Saiku.tabs.add(new Workspace);return!1},run_dashboard:function(){if(void 0===Saiku.Dashboards)alert("Please upgrade to Saiku Enterprise for Dashboards");else{var a=_.find(Saiku.tabs._tabs,function(a){return a.content instanceof Dashboards});a?a.select():Saiku.tabs.add(new Dashboards)}return!1},setup_page:function(){var a=$(window).height(),b=$("nav li.active a").attr("class");$("body").height(a);$(".stabs section").each(function(){$(this).height()});
$("#"+b).fadeIn()},hide_content_enterprise:function(){this.$el.find(".enterprisetoggle").css("visibility","hidden");this.$el.find("#splash #welcome").css({background:'url("../../../images/src/mac.png") top right no-repeat'})},get_content:function(){var a=this;$.ajax({type:"GET",url:"http://meteorite.bi/content.json",async:!1,contentType:"application/json",dataType:"jsonp",jsonpCallback:"jsonCallback2",cache:!0,success:function(b){a.$el.find(".responsive-container").fitVids();a.$el.html(a.template());
Settings.LICENSE&&"trial"!==Settings.LICENSE.licenseType&&"Open Source License"!==Settings.LICENSE.licenseType&&a.hide_content_enterprise()},error:function(){a.$el.html(a.template());Settings.LICENSE&&"trial"!==Settings.LICENSE.licenseType&&"Open Source License"!==Settings.LICENSE.licenseType&&a.hide_content_enterprise()}})}}),SessionWorkspace=Backbone.Model.extend({initialize:function(a,b){_.extend(this,Backbone.Events);_.bindAll(this,"process_datasources","prefetch_dimensions");this.initialized=
!1;this.first=!0;"undefined"!==typeof localStorage&&localStorage&&(Settings.LOCALSTORAGE_EXPIRATION&&0!==Settings.LOCALSTORAGE_EXPIRATION||localStorage.clear(),localStorage.getItem("expiration")&&localStorage.getItem("expiration")<=(new Date).getTime()?localStorage.clear():localStorage.getItem("saiku-version")&&localStorage.getItem("saiku-version")===Settings.VERSION||(localStorage.clear(),localStorage.setItem("saiku-version",Settings.VERSION)));Saiku.ui.block("Loading datasources....");this.fetch({success:this.process_datasources},
{})},refresh:function(){"undefined"!==typeof localStorage&&localStorage&&localStorage.clear();this.clear();"undefined"!==typeof localStorage&&localStorage&&localStorage.setItem("saiku-version",Settings.VERSION);this.fetch({success:this.process_datasources},{})},destroy:function(){"undefined"!==typeof localStorage&&localStorage&&localStorage.clear();return!1},render_default_tab:function(a,b){null!=b&&b.unbind("report:rendered");for(var c=this,d=0;d<a.length;d++)if(a[0].visible){filePath=a[0].path;
if(filePath.indexOf(".saiku")===filePath.length-6){Saiku.ui.block("Loading default report...");fileName=filePath.replace(/^.*[\\\/]/,"");var e=new SavedQuery({file:filePath,name:fileName}),d={fileType:"saiku",name:fileName.split(".saiku")[0]},f=_.extend({file:e.get("file"),formatter:Settings.CELLSET_FORMATTER},Settings.PARAMS),e=new Query(f,{name:e.get("name")}),d=new Workspace({query:e,item:d,viewState:null});Saiku.tabs.add(d);a.shift();d.bind("report:rendered",function(){c.render_default_tab(a)})}else filePath.indexOf(".sdb")===
filePath.length-4&&(Saiku.Dashboards?(Saiku.ui.block("Loading default report..."),Saiku.tabs.add(new DashboardViewTab({file:a[d].path}))):!Settings.INITIAL_QUERY&&paramsURI.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace));break}else a.shift()},process_datasources:function(a,b){if("undefined"!==typeof localStorage&&localStorage&&null===localStorage.getItem("session")){localStorage.setItem("session",JSON.stringify(b));var c=(new Date).getTime()+Settings.LOCALSTORAGE_EXPIRATION;
"undefined"!==typeof localStorage&&localStorage&&localStorage.setItem("expiration",c)}this.cube_navigation=_.template($("#template-cubes").html())({connections:b});this.cube={};this.connections=b;_.delay(this.prefetch_dimensions,20);if(this.initialized)Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace);else{$(Saiku.toolbar.el).prependTo($("#header"));$("#header").show();Saiku.ui.unblock();Saiku.tabs.render();Saiku.events.trigger("session:new",{session:this});var d=Saiku.URLParams.paramsURI();if(!_.has(d,
"splash"))d.splash=!0;else if(_.has(d,"splash")&&d.splash||_.has(d,"splash")&&null===d.splash)d.splash=!0;if(Settings.DEFAULT_REPORT_SHOW){var e=function(){var a,b;if(0<_.size(Settings.DEFAULT_REPORTS)&&0<l.length)for(b=0;b<l.length;b++)if(l[0].visible){a=l[0].path;if(a.indexOf(".saiku")===a.length-6){Saiku.ui.block("Loading default report...");b=a.replace(/^.*[\\\/]/,"");a=new SavedQuery({file:a,name:b});b={fileType:"saiku",name:b.split(".saiku")[0]};var c=_.extend({file:a.get("file"),formatter:Settings.CELLSET_FORMATTER},
Settings.PARAMS);a=new Query(c,{name:a.get("name")});var e=new Workspace({query:a,item:b,viewState:null});Saiku.tabs.add(e);l.shift();e.bind("report:rendered",function(){k.render_default_tab(l,e)})}else a.indexOf(".sdb")===a.length-4&&(Saiku.Dashboards?(Saiku.ui.block("Loading default report..."),Saiku.tabs.add(new DashboardViewTab({file:l[b].path})),l.shift(),k.render_default_tab(l,null)):!Settings.INITIAL_QUERY&&d.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace));
break}else l.shift();else!Settings.INITIAL_QUERY&&d.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace)};!Settings.INITIAL_QUERY&&d.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace);var c=Settings.DEFAULT_REPORTS._,f=[];_.each(Saiku.session.roles,function(a){a=Settings.DEFAULT_REPORTS[a];void 0!=a&&0<a.length&&(f=f.concat(a))});var h=0,k=this,l=c.concat(Settings.DEFAULT_REPORTS[Saiku.session.username]).concat(f),
h=setInterval(function(){console.log("window.DashboardViewTab",window.DashboardViewTab);console.log("typeof window.DashboardViewTab",typeof window.DashboardViewTab);void 0===Saiku.Dashboards?(clearInterval(h),e()):"undefined"!==typeof window.DashboardViewTab&&(clearInterval(h),e())},100)}else!Settings.INITIAL_QUERY&&d.splash?Saiku.tabs.add(new SplashScreen):Settings.INITIAL_QUERY||Saiku.tabs.add(new Workspace)}},prefetch_dimensions:function(){for(var a=0,b=this.connections.length;a<b;a++)for(var c=
this.connections[a],d=0,e=c.catalogs.length;d<e;d++)for(var f=c.catalogs[d],h=0,k=f.schemas.length;h<k;h++)for(var l=f.schemas[h],g=0,m=l.cubes.length;g<m;g++){var n=c.name+"/"+f.name+"/"+(""===l.name||null===l.name?"null":l.name)+"/"+encodeURIComponent(l.cubes[g].name);"undefined"!==typeof localStorage&&localStorage&&null!==localStorage.getItem("cube."+n)?this.cube[n]=new Cube(JSON.parse(localStorage.getItem("cube."+n))):(this.cube[n]=new Cube({key:n}),!0===Settings.DIMENSION_PREFETCH&&this.cube[n].fetch())}!this.initialized&&
Backbone.history&&(Backbone.history.start(),this.initialized=!0)},url:function(){return this.first?(this.first=!1,encodeURI(Saiku.session.username+"/discover")):encodeURI(Saiku.session.username+"/discover/refresh")}}),Member=Backbone.Model.extend({initialize:function(a,b){this.cube=b.cube;var c=b.dimension.split("/");this.hierarchy=decodeURIComponent(c[0]);this.level=decodeURIComponent(c[1])},url:function(){return encodeURI(Saiku.session.username+"/discover/")+this.cube+"/hierarchies/"+encodeURIComponent(this.hierarchy)+
...
"function"===typeof b&&b({status:"error",data:a})}})}}),Saiku={toolbar:{},tabs:new TabSet,introDone:!1,splash:new SplashScreen({toolbar:this.toolbar}),session:null,events:_.extend({},Backbone.Events),routers:[],leaflet:"undefined"!==typeof L?L:{},ui:{block:function(a){$(".processing_message").html(a);$(".processing_message").removeClass("i18n_translated").addClass("i18n");Saiku.i18n.translate();$(".processing, .processing_container").show()},unblock:function(){$(".processing, .processing_container, .blockOverlay").hide();
$(".blockUI").fadeOut("slow")}},log:function(a,b){console&&console.log&&(console.log("Logging for: "+a),b&&console.log(b))},error:function(a,b){console&&console.error&&(console.error("Logging for: "+a),console.error(b))},URLParams:{buildValue:function(a){return/^\s*$/.test(a)?null:/^(true|false)$/i.test(a)?"true"===a.toLowerCase():isFinite(a)?parseFloat(a):a},joinArrayValues:function(a){return 2===a.length?a[1]:a[1]+"\x3d"+a[2]},paramsURI:function(){var a={},b=window.location.search.substr(1).split("\x26"),
c=b.length,d,e;if(1<window.location.search.length)for(d=0;d<c;d++)e=b[d].split("\x3d"),a[decodeURIComponent(e[0])]=1<e.length?this.buildValue(decodeURIComponent(this.joinArrayValues(e))):null;return a},equals:function(){var a=Array.prototype.slice.call(arguments),b=this.paramsURI();return _.isEqual(b,a[0])?!0:!1},contains:function(){var a=Array.prototype.slice.call(arguments),b=this.paramsURI(),c={},d;for(d in b)b.hasOwnProperty(d)&&a[0][d]&&b[d]===a[0][d]&&(c[d]=a[0][d]);return _.isEqual(c,a[0])?
!0:!1}},loadCSS:function(a,b){var c=window.document.createElement("link"),d=window.document.getElementsByTagName("script")[0];c.rel="stylesheet";c.href=a;c.media="only x";d.parentNode.insertBefore(c,d);setTimeout(function(){c.media=b||"all"});return c},loadJS:function(a,b){var c=window.document.createElement("script"),d=window.document.getElementsByTagName("script")[0];c.src=a;c.async=!0;d.parentNode.insertBefore(c,d);b&&"function"===typeof b&&(c.onload=b);return c},toPattern:function(a,b){for(var c=
("object"===typeof b?b.pattern:b).split(""),d=a?a.toString().replace(/[^0-9a-zA-Z]/g,""):"",e=0,f=c.length,h=0;h<f&&!(e>=d.length);h++)if("9"===c[h]&&d[e].match(/[0-9]/)||"A"===c[h]&&d[e].match(/[a-zA-Z]/)||"S"===c[h]&&d[e].match(/[0-9a-zA-Z]/))c[h]=d[e++];else if("9"===c[h]||"A"===c[h]||"S"===c[h])c=c.slice(0,h);return c.join("").substr(0,h)},replaceString:function(a,b,c){for(var d=c.length,e=0;e<d;e++)c.substring(e,e+a.length)===a&&(c=c.substring(0,e)+b+c.substring(e+a.length,c.length));return c},
removeBrackets:function(a){return a.toString().replace(/[\[\]]/gi,"")},trimFirstLastChar:function(a,b){var c=a.toString();return"first"===b?c.substring(1,c.length):"last"===b?c.substring(0,c.length-1):c.substring(1,c.length-1)}};Saiku.singleton=function(){var a;Saiku.singleton=function(){if(a)return a;a=this;this.set=function(a){this.data=a};this.get=function(){return this.data}};return Saiku.singleton}();Backbone.emulateHTTP=!1;
Settings.BIPLUGIN||$(document).ready(function(){var a=new PluginCollection;a.fetch({success:function(){var b=new SettingsOverrideCollection;b.fetch({success:function(){var c=a.size(),d=0;a.each(function(a){d+=1;if("js/saiku/plugins/I18n/plugin.js"!==a.attributes.path)jQuery.ajax({async:!1,type:"GET",url:a.attributes.path,data:null,success:function(){if(d===c){var a=b.size(),e=0;b.each(function(b){e+=1;for(var c in b.attributes)b.attributes.hasOwnProperty(c)&&(Settings[c]=b.attributes[c]);void 0!==
Settings.CSS&&Saiku.loadCSS(Settings.CSS,null);a===e&&(Saiku.session=new Session({},{username:Settings.USERNAME,password:Settings.PASSWORD}),Saiku.toolbar=new Toolbar)})}},dataType:"script"});else if(d===c){var f=b.size(),h=0;b.each(function(a){h+=1;for(var b in a.attributes)a.attributes.hasOwnProperty(b)&&(Settings[b]=a.attributes[b]);void 0!==Settings.CSS&&Saiku.loadCSS(Settings.CSS,null);f===h&&(Saiku.session=new Session({},{username:Settings.USERNAME,password:Settings.PASSWORD}),Saiku.toolbar=
new Toolbar)})}})},error:function(){var b=a.size(),d=0;a.each(function(a){d+=1;"js/saiku/plugins/I18n/plugin.js"!==a.attributes.path?jQuery.ajax({async:!1,type:"GET",url:a.attributes.path,data:null,success:function(){d===b&&(void 0!==Settings.CSS&&Saiku.loadCSS(Settings.CSS,null),Saiku.session=new Session({},{username:Settings.USERNAME,password:Settings.PASSWORD}),Saiku.toolbar=new Toolbar)},dataType:"script"}):d===b&&(void 0!==Settings.CSS&&Saiku.loadCSS(Settings.CSS,null),Saiku.session=new Session({},
{username:Settings.USERNAME,password:Settings.PASSWORD}),Saiku.toolbar=new Toolbar)})}})}})});var SaikuTimeLogger=function(a){this._element=$(a);this._timestamps=[];this._events=[]};SaikuTimeLogger.prototype.log=function(a){var b=(new Date).getTime();a||(a="Unknown");if(0<this._timestamps.length){var c=this._timestamps[this._timestamps.length-1];1<b-c&&this._element.append("\x3cdiv\x3e"+(b-c)+" ms "+a+" (previous: "+this._events[this._events.length-1]+" )\x3c/div\x3e")}this._timestamps.push(b);this._events.push(a)};
...
template_many_years_mdx:" {logicalOperator} {parent}.CurrentMember.NAME {comparisonOperator} '{dates}'",template_mdx:"IIF(ISEMPTY(CurrentDateMember([{dimension}.{hierarchy}], '[\"{dimension}.{hierarchy}\"]\\.{analyzerDateFormat}', EXACT){lag}), {}, { {parent} CurrentDateMember([{dimension}.{hierarchy}], '[\"{dimension}.{hierarchy}\"]\\.{analyzerDateFormat}', EXACT){lag}})",template_last_mdx:"{parent} LastPeriods({periodAmount}, CurrentDateMember([{dimension}.{hierarchy}], '[\"{dimension}.{hierarchy}\"]\\.{analyzerDateFormat}', EXACT))",
...
function(b,c){return a[c]})):a.parent="";if("dayperiods"===b){a.parent="[{dimension}.{hierarchy}].[{level}]";a.parent=a.parent.replace(/{(\w+)}/g,function(b,c){return a[c]});if(1<this.selectedDates.length){b=this.selectedDates.length;for(c=0;c<b;c++)if(a.dates=this.selectedDates[c],"\x3e\x3d|\x3c\x3d"===a.comparisonOperator)0===c?(a.comparisonOperator=a.comparisonOperator.split("|")[0],this.template_days_mdx=this.template_days_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]}),a.comparisonOperator=
"\x3e\x3d|\x3c\x3d"):(a.logicalOperator="AND",a.comparisonOperator=a.comparisonOperator.split("|")[1],this.template_days_mdx+=this.template_many_years_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]}));else if("\x3e\x3d||\x3c\x3d"===a.comparisonOperator)if(0===c)this.template_days_mdx="EXCEPT({parent}.Members, "+this.template_days_mdx,a.comparisonOperator=a.comparisonOperator.split("||")[0],this.template_days_mdx=this.template_days_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]}),a.comparisonOperator=
"\x3e\x3d||\x3c\x3d";else return a.logicalOperator="AND",a.comparisonOperator=a.comparisonOperator.split("||")[1],this.template_days_mdx+=this.template_many_years_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]}),this.template_days_mdx+"))";else 0===c?this.template_days_mdx=this.template_days_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]}):(a.logicalOperator="\x3c\x3e"===a.comparisonOperator?"AND":"OR",this.template_days_mdx+=this.template_many_years_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]}));
return this.template_days_mdx+")"}a.dates=this.selectedDates[0];return this.template_days_mdx=this.template_days_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]})+")"}if("lastperiods"===b)return this.template_last_mdx=this.template_last_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]});a.lag="yesterday"===b?".lag(1)":"";return this.template_mdx=this.template_mdx.replace(/{(\w+)}/g,function(b,c){return a[c]})},save:function(a){a.preventDefault();a=$("\x3cdiv\x3eSaving...\x3c/div\x3e");$(this.el).find(".dialog_body").children().hide();
$(this.el).find(".dialog_body").prepend(a);var b=this,c,d,e,f,h=null,k={};if(null===b.hierarchy||void 0===b.hierarchy)b.hierarchy=b.dimension;this.$el.find(".available-selections").each(function(a,g){if("true"===$(g).attr("available")){k.type=$(g).attr("selection-name");"operator"===$(g).attr("selection-name")?$(g).find("input:radio").each(function(a,e){if(!0===$(e).is(":checked")){var f=$(e).data("operator");k.checked=$(e).attr("id");if("after"===f||"after\x26equals"===f||"before"===f||"before\x26equals"===
f)b.selectedDates=[],b.selectedDates.push(b.$el.find("#selection-date").val());else if("between"===f||"notbetween"===f)b.selectedDates=[],b.selectedDates.push(b.$el.find("#start-date").val()),b.selectedDates.push(b.$el.find("#end-date").val());c="dayperiods";d=$(e).val();k.values=b.selectedDates}}):"fixed-date"===$(g).attr("selection-name")?$(g).find("input:radio").each(function(a,b){!0===$(b).is(":checked")&&(c=$(b).attr("id").split("-")[1],e=$(b).val(),k.checked=$(b).attr("id"))}):"rolling-date"===
$(g).attr("selection-name")&&(e=$("#period-select").find(":selected").val(),c="lastperiods",f=$(g).find("input:text").val(),k.fixedDateName=c,k.periodAmount=$(g).find("input:text").val(),k.periodSelect=$("#period-select").find(":selected").attr("id"));var l=b.dataLevels.length,p,B;for(B=0;B<l;B++)b.dataLevels[B].analyzerDateFormat===e&&(p=b.dataLevels[B].name);l={dimension:b.dimension,hierarchy:b.hierarchy,level:b.name,analyzerDateFormat:e,periodAmount:f,comparisonOperator:d,workinglevel:p};h="dayperiods"===
c&&""!==b.selectedDates[0]&&void 0!==b.selectedDates[0]||"lastperiods"===c&&!_.isEmpty(e)&&"Day(s)"!==e&&!_.isEmpty(f)||"dayperiods"!==c&&"lastperiods"!==c&&!_.isEmpty(e)?b.populate_mdx(l,c):null}});var l=decodeURIComponent(this.member.hierarchy);a=decodeURIComponent(this.member.level);l=this.workspace.query.helper.getHierarchy(l);this.get_cube_name();_.extend(k,this.levelInfo);if("dayperiods"===c&&""!==this.selectedDates[0]&&void 0!==b.selectedDates[0]||"lastperiods"===c&&!_.isEmpty(e)&&"Day(s)"!==
e&&!_.isEmpty(f)||"dayperiods"!==c&&"lastperiods"!==c&&!_.isEmpty(e))this.set_date_filter(k);else{var g=this.get_uuid(k);this.workspace.dateFilter.remove(g);this.workspace.query.setProperty("saiku.ui.datefilter.data",this.workspace.dateFilter.toJSON())}l&&l.levels.hasOwnProperty(a)&&(l.levels[a]={mdx:h,name:a});this.finished()},get_cube_name:function(){return decodeURIComponent(this.workspace.selected_cube.split("/")[3])},get_uuid:function(a){return"["+a.cube+"]."+this.dimHier+".["+a.name+"]"},set_date_filter:function(a){var b=
...
var WarningModal=Modal.extend({type:"info",buttons:[{text:"Okay",method:"okay"},{text:"Cancel",method:"close"}],initialize:function(a){var b=this;this.options.title=a.title;this.message='\x3cspan class\x3d"i18n"\x3e'+a.message+"\x3c/span\x3e";this.okayfunction=a.okay;this.okaycallbackobject=a.okayobj;this.cancelfunction=a.cancel;this.cancelcallbackobject=a.cancelobj;this.bind("open",function(){b.$el.closest(".ui-dialog").on("keydown",function(a){a.keyCode===$.ui.keyCode.ESCAPE&&b.close(a)});b.$el.closest(".ui-dialog").find(".ui-dialog-titlebar-close").on("click",
function(a){b.close(a)})})},okay:function(a){a.preventDefault();_.isFunction(this.okayfunction)&&this.okayfunction(this.okaycallbackobject);this.$el.dialog("close")},close:function(a){"#close"===a.target.hash&&a.preventDefault();_.isFunction(this.cancelfunction)&&this.cancelfunction(this.cancelcallbackobject);this.$el.dialog("close")}});
(function(a){var b;a:{try{document.createElement("$")}catch(c){b=c;break a}b=void 0}a.Base64||(a.Base64={encode:function(a){for(var c,f,h,k,l,g,m=0,n=a.length,s=Math.max,p="";m<n;){c=a.charCodeAt(m++)||0;f=a.charCodeAt(m++)||0;g=a.charCodeAt(m++)||0;if(255<s(c,f,g))throw b;h=c>>2&63;c=(c&3)<<4|f>>4&15;k=(f&15)<<2|g>>6&3;l=g&63;f?g||(l=64):k=l=64;p+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(h)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(c)+
"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(k)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt(l)}return p}})})(this);
Backbone.sync=function(a,b,c){methodMap={create:"POST",read:"GET",update:"PUT","delete":"DELETE"};var d=methodMap[a],e=Settings.REST_URL+(_.isFunction(b.url)?b.url():b.url);"undefined"==typeof Settings.ERRORS&&(Settings.ERRORS=0);var f=function(){Settings.ERRORS++;Settings.ERRORS<Settings.ERROR_TOLERANCE?Saiku.session.logout():Saiku.ui.block("Communication problem with the server. Please reload the application...")};a=!0;!1===c.async&&(a=!1);var h="json";"undefined"!=typeof c.dataType&&(h=c.dataType);
var k="application/x-www-form-urlencoded";"undefined"!=typeof c.contentType&&(k=c.contentType);b=b.attributes;"undefined"!=typeof c.data&&(b=c.data);b={url:e,type:d,cache:!1,data:b,contentType:k,dataType:h,success:function(a,b,d){Settings.ERRORS=0;Saiku.ui.unblock();c.success(a,b,d)},statusCode:{0:function(){f()},401:function(){f()}},error:function(a,b,f){!isIE&&"undefined"!=typeof console&&console&&console.error&&(console.error("Error performing "+d+" on "+e),console.error(f));c.error&&c.error(a,
...
var ChartEditor=Modal.extend({type:"chart-editor",message:'\x3cform class\x3d"form-group-inline"\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"chart-title" class\x3d"i18n"\x3eChart Title:\x3c/label\x3e\x3cinput type\x3d"text" class\x3d"form-control" id\x3d"chart-title"\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"xtitle" class\x3d"i18n"\x3eX Axis label:\x3c/label\x3e\x3cinput type\x3d"text" class\x3d"form-control" id\x3d"xtitle"\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"ytitle" class\x3d"i18n"\x3eY Axis label:\x3c/label\x3e\x3cinput type\x3d"text" class\x3d"form-control" id\x3d"ytitle"\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"colors" class\x3d"i18n"\x3eColors:\x3c/label\x3e\x3cdiv class\x3d"container-colors"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"clearfix"\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"legend" class\x3d"i18n"\x3eShow Legend:\x3c/label\x3e\x3clabel for\x3d"legend" class\x3d"lbl-legend-yes i18n"\x3e\x3cinput type\x3d"radio" name\x3d"legend" value\x3d"true" checked\x3e Yes\x3c/label\x3e\x3clabel for\x3d"legend" class\x3d"lbl-legend-no i18n"\x3e\x3cinput type\x3d"radio" name\x3d"legend" value\x3d"false"\x3e No\x3c/label\x3e\x3c/div\x3e\x3cdiv class\x3d"div-trend hide"\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"trend-line" class\x3d"i18n"\x3eTrend Line:\x3c/label\x3e\x3cselect class\x3d"form-control" id\x3d"trend-line"\x3e\x3coption value\x3d"none" class\x3d"i18n"\x3eNone\x3c/option\x3e\x3coption value\x3d"linear" class\x3d"i18n"\x3eLinear\x3c/option\x3e\x3coption value\x3d"weighted-moving-average" class\x3d"i18n"\x3eWeighted Moving Average\x3c/option\x3e\x3coption value\x3d"moving-average" class\x3d"i18n"\x3eMoving Average\x3c/option\x3e\x3c/select\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3cdiv class\x3d"div-trend-points"\x3e\x3clabel for\x3d"trend-points" class\x3d"i18n"\x3eTrend Periods:\x3c/label\x3e\x3cinput type\x3d"text" class\x3d"form-control" id\x3d"trend-points" value\x3d"3"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"div-multiplesunburst hide"\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"multiplesunburst-multichartmax" class\x3d"i18n"\x3eMax number of charts:\x3c/label\x3e\x3cinput type\x3d"number" class\x3d"form-control" id\x3d"multiplesunburst-multichartmax" min\x3d"0" value\x3d"30" style\x3d"width: 160px;"\x3e\x3c/div\x3e\x3c/div\x3e\x3cdiv class\x3d"div-pie hide"\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"pie-values-label-style" class\x3d"i18n"\x3eValues Label Style:\x3c/label\x3e\x3cselect class\x3d"form-control" id\x3d"pie-values-label-style"\x3e\x3coption value\x3d"linked" class\x3d"i18n"\x3eLinked\x3c/option\x3e\x3coption value\x3d"inside" class\x3d"i18n"\x3eInside\x3c/option\x3e\x3c/select\x3e\x3c/div\x3e\x3cdiv class\x3d"form-group"\x3e\x3clabel for\x3d"pie-values-mask" class\x3d"i18n"\x3eValues Mask:\x3c/label\x3e\x3cinput type\x3d"text" class\x3d"form-control" id\x3d"pie-values-mask" value\x3d"{value.percent}"\x3e\x3c/div\x3e\x3c/div\x3e\x3c/form\x3e',buttons:[{text:"Add Color Palette",
method:"add_color_palette"},{text:"Save",method:"save"},{text:"Cancel",method:"close"}],events:{"click .dialog_footer a":"call","change #trend-line":"hide_periods"},initialize:function(a){_.extend(this,a);this.options.closeOnEscape=!1;this.options.title="Chart Settings";this.renderer={};var b=this;a&&a.workspace&&a.data&&(this.workspace=a.workspace,this.renderer=a.data);_.bindAll(this,"template_editor","add_color_palette","get_chart_properties","hide_periods");this.bind("open",function(){this.get_chart_properties();
this.$el.closest(".ui-dialog").on("keydown",function(a){a.keyCode===$.ui.keyCode.ESCAPE&&b.close(a)})})},template_editor:function(){return this.message},spectrum_options:function(a){return{color:a,showInput:!0,showInitial:!0,showPalette:!0,showSelectionPalette:!0,maxPaletteSize:10,preferredFormat:"hex",palette:["rgb(0, 0, 0);rgb(67, 67, 67);rgb(102, 102, 102);rgb(153, 153, 153);rgb(183, 183, 183);rgb(204, 204, 204);rgb(217, 217, 217);rgb(239, 239, 239);rgb(243, 243, 243);rgb(255, 255, 255)".split(";"),
"rgb(152, 0, 0);rgb(255, 0, 0);rgb(255, 153, 0);rgb(255, 255, 0);rgb(0, 255, 0);rgb(0, 255, 255);rgb(74, 134, 232);rgb(0, 0, 255);rgb(153, 0, 255);rgb(255, 0, 255)".split(";"),"rgb(230, 184, 175);rgb(244, 204, 204);rgb(252, 229, 205);rgb(255, 242, 204);rgb(217, 234, 211);rgb(208, 224, 227);rgb(201, 218, 248);rgb(207, 226, 243);rgb(217, 210, 233);rgb(234, 209, 220);rgb(234, 153, 153);rgb(249, 203, 156);rgb(255, 229, 153);rgb(182, 215, 168);rgb(162, 196, 201);rgb(164, 194, 244);rgb(159, 197, 232);rgb(180, 167, 214);rgb(213, 166, 189);rgb(204, 65, 37);rgb(246, 178, 107);rgb(255, 217, 102);rgb(147, 196, 125);rgb(118, 165, 175);rgb(109, 158, 235);rgb(111, 168, 220);rgb(142, 124, 195);rgb(194, 123, 160);rgb(166, 28, 0);rgb(204, 0, 0);rgb(241, 194, 50);rgb(106, 168, 79);rgb(69, 129, 142);rgb(60, 120, 216);rgb(61, 133, 198);rgb(103, 78, 167);rgb(166, 77, 121);rgb(133, 32, 12);rgb(153, 0, 0);rgb(180, 95, 6);rgb(56, 118, 29);rgb(19, 79, 92);rgb(17, 85, 204);rgb(11, 83, 148);rgb(53, 28, 117);rgb(116, 27, 71);rgb(91, 15, 0);rgb(102, 0, 0);rgb(120, 63, 4);rgb(127, 96, 0);rgb(12, 52, 61);rgb(28, 69, 135);rgb(7, 55, 99);rgb(32, 18, 77);rgb(76, 17, 48)".split(";")]}},
add_color_palette:function(a,b){a&&a.preventDefault();var c=_.uniqueId("color"),d="#"+Math.floor(16777215*Math.random()).toString(16),d=b||d,e='\x3cinput type\x3d"color" id\x3d"'+c+'"\x3e';this.$el.find(".container-colors").append(e);this.$el.find("#"+c).spectrum(this.spectrum_options(d));this.$el.find("#"+c).on("beforeShow.spectrum",this.delete_color_palette);this.$el.find(".sp-replacer").hover(this.delete_color_palette);this.$el.find(".sp-replacer").click(this.delete_color_palette)},delete_color_palette:function(a){var b=
$(a.currentTarget);"beforeShow"===a.type&&(Saiku.inputColorUID=a.target.id);b.find(".delete-color").remove();"mouseover"===a.type||"mouseenter"===a.type||"click"===a.type?b.append('\x3ca href\x3d"#delete_color_palette" class\x3d"delete-color"\x3ex\x3c/a\x3e'):b.find(".delete-color").remove();"click"===a.type&&$(a.target).hasClass("delete-color")&&($(".sp-container").addClass("sp-hidden"),$("#"+Saiku.inputColorUID).spectrum("destroy"),$("#"+Saiku.inputColorUID).remove(),b.remove())},get_chart_properties:function(){var a=
Array.prototype.slice.call(arguments),b={};_.isEmpty(a)?b=this.workspace.query.getProperty("saiku.ui.chart.options"):(this.$el=a[0].element,this.renderer.type=a[0].type,a[0].chartDefinition&&!_.isEmpty(a[0].chartDefinition)&&(b.chartDefinition=_.isString(a[0].chartDefinition)?JSON.parse(a[0].chartDefinition):a[0].chartDefinition));void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.title&&this.$el.find("#chart-title").val(b.chartDefinition.title);void 0!==b&&void 0!==b.chartDefinition&&
null!==b.chartDefinition.baseAxisTitle&&this.$el.find("#xtitle").val(b.chartDefinition.baseAxisTitle);void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.orthoAxisTitle&&this.$el.find("#ytitle").val(b.chartDefinition.orthoAxisTitle);if(void 0===b||void 0===b.chartDefinition||void 0===b.chartDefinition.colors)for(var a=["#bb0000","#007070","#74af00"],c=a.length,d=0;d<c;d++)this.add_color_palette(null,a[d]);else for(c=b.chartDefinition.colors.length,d=0;d<c;d++)this.add_color_palette(null,
b.chartDefinition.colors[d]);void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.legend&&this.$el.find('input[type\x3dradio][value\x3d"'+b.chartDefinition.legend+'"]').first().attr("checked","checked");"line"===this.renderer.type?(this.$el.find(".div-trend").show(),void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.trend?(this.$el.find("#trend-line").val(b.chartDefinition.trend.type),"linear"!==b.chartDefinition.trend.type||"none"!==b.chartDefinition.trend.type?(this.$el.find(".div-trend-points").show(),
this.$el.find("#trend-points").val(b.chartDefinition.trend.periods)):this.$el.find(".div-trend-points").hide()):this.$el.find(".div-trend-points").hide()):"multiplesunburst"===this.renderer.type?(this.$el.find(".div-multiplesunburst").show(),void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.multiChartMax&&this.$el.find("#multiplesunburst-multichartmax").val(b.chartDefinition.multiChartMax||30)):"pie"===this.renderer.type?(this.$el.find(".div-pie").show(),void 0!==b&&void 0!==b.chartDefinition&&
null!==b.chartDefinition.valuesLabelStyle&&this.$el.find("#pie-values-label-style").val(b.chartDefinition.valuesLabelStyle||"linked"),void 0!==b&&void 0!==b.chartDefinition&&null!==b.chartDefinition.valuesMask&&this.$el.find("#pie-values-mask").val(b.chartDefinition.valuesMask||"{value.percent}")):(this.$el.find(".div-trend").hide(),this.$el.find(".div-multiplesunburst").hide(),this.$el.find(".div-pie").hide())},hide_periods:function(a){a.preventDefault();a=$(a.currentTarget).val();"linear"!==a&&
"none"!==a?this.$el.find(".div-trend-points").show():this.$el.find(".div-trend-points").hide()},save:function(a){a.preventDefault();var b=this;a={};var c=[],d;a.chartDefinition={};this.renderer.cccOptions.title=this.$el.find("#chart-title").val();null!==this.$el.find("#chart-title").val()&&(a.chartDefinition.title=this.$el.find("#chart-title").val());null!==this.$el.find("#xtitle").val()&&(a.chartDefinition.baseAxisTitle=this.$el.find("#xtitle").val());null!==this.$el.find("#ytitle").val()&&(a.chartDefinition.orthoAxisTitle=
this.$el.find("#ytitle").val());$.each(this.$el.find('.container-colors \x3e input[type\x3d"color"]'),function(a,d){c.push(b.$el.find("#"+$(d).attr("id")).spectrum("get").toHexString())});a.chartDefinition.colors=c;a.chartDefinition.legend="true"===this.$el.find("input:radio[name\x3dlegend]:checked").val();"none"!==this.$el.find("#trend-line").val()?a.chartDefinition.trend={type:this.$el.find("#trend-line").val(),periods:this.$el.find("#trend-points").val()}:a.chartDefinition.trend=null;"multiplesunburst"===
this.renderer.type&&(a.chartDefinition.multiChartMax=this.$el.find("#multiplesunburst-multichartmax").val()||30);"pie"===this.renderer.type&&(a.chartDefinition.valuesLabelStyle=this.$el.find("#pie-values-label-style").val(),a.chartDefinition.valuesMask=this.$el.find("#pie-values-mask").val()||"{value.percent}");d=(d=this.workspace.querytoolbar.$el.find("ul.chart li").not(".chart_editor").find("a.on").attr("href"))?d.replace("#",""):"stackedBar";this.workspace.querytoolbar.$el.find('ul.chart [href\x3d"#charteditor"]').addClass("on");
this.renderer.switch_chart(this.renderer.type,a);this.workspace.query.setProperty("saiku.ui.chart.options",a);this.workspace.query.setProperty("saiku.ui.render.type",d);this.$el.dialog("close")},close:function(a){a.preventDefault();$(".sp-container").addClass("sp-hidden");this.$el.dialog("close")}}),Tour=Backbone.View.extend({initialize:function(a){_.bindAll(this,"run_tour");_.extend(this,Backbone.Events);this.toolbar=a.toolbar},run_tour:function(){var a=this,b=[{content:"\x3cp\x3eClick here to open a new query.\x3c/p\x3e",
highlightTarget:!0,nextButton:!1,closeButton:!0,target:$("#new_query"),my:"top left",at:"right bottom",setup:function(a,b){Saiku.events.bind("toolbar:new_query",this.onSelectKitten)},teardown:function(a,b){Saiku.events.unbind("toolbar:new_query",this.onSelectKitten)},bind:["onSelectKitten"],onSelectKitten:function(a,b,e,f){b.view=f;a.next()}},{content:"\x3cp\x3eSelect the Foodmart Sales Cube\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$(".cubes"),my:"bottom center",at:"top center",
setup:function(a,b){Saiku.events.bind("workspace:new_query",this.onSelectCube)},teardown:function(a,b){Saiku.events.unbind("workspace:new_query",this.onSelectCube)},bind:["onSelectCube"],onSelectCube:function(b,d,e,f){"Sales"===f.cube?(d.view=f.view,setTimeout(function(){a.exec||(a.exec=!0);b.next()},200)):$(".tour-container").html("\x3cp\x3eYou didn't select the Sales cube.\x3c/p\x3e")}},{content:"\x3cp\x3eGreat, next we need to execute a query.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,
target:$(".dimension_tree"),my:"bottom center",at:"top center",setup:function(a,b){return{target:$(".dimension_tree")}}},{content:"\x3cp\x3eFirst lets expand the Customer dimension.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$('a[title\x3d"Customer"]'),my:"left center",at:"right center",setup:function(a,b){Saiku.events.bind("workspace:expandDimension",this.onExpandDimension);return{target:$('a[title\x3d"Customer"]')}},bind:["onExpandDimension"],onExpandDimension:function(a,
b,e,f){a.next()}},{content:"\x3cp\x3eGreat next drag the State Province level to the Rows dropzone.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$(".rows_fields"),my:"left center",at:"right center",setup:function(a,b){Saiku.events.bind("workspaceDropZone:select_dimension",this.onSelectLevel);$('a[title\x3d"State Province"]').addClass("tour-highlight");return{target:$(".rows_fields")}},bind:["onSelectLevel"],onSelectLevel:function(a,b,e,f){"[Customer].[Customers]"===f.hierarchy&&
"State Province"===f.level?a.next():$(".tour-container").html("\x3cp\x3eYou didn't select the correct level. Remove this one and replace it with the highlighted level.\x3c/p\x3e")}},{content:"\x3cp\x3eNext we'll add a measure. Drag Unit Sales into the Measures Drop Zone.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$(".rows_fields"),my:"left top",at:"right bottom",setup:function(a,b){Saiku.events.bind("workspaceDropZone:select_measure",this.onSelectMeasure);return{target:$('a[title\x3d"[Measures].[Unit Sales]"]')}},
bind:["onSelectMeasure"],onSelectMeasure:function(a,b,e,f){"Unit Sales"===f.measure.name?a.next():$(".tour-container").html("\x3cp\x3eYou didn't select the correct measure. Remove this one and replace it with the highlighted measure.\x3c/p\x3e")}},{content:"\x3cp\x3eGreat, we've now run a very basic query. Now we'll view it as a chart.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"bottom center",at:"top center",setup:function(a,b){return{target:$("div.table_wrapper")}}},
{content:"\x3cp\x3eTo view your data as a chart, click on the chart icon.\x3c/p\x3e",highlightTarget:!0,nextButton:!1,closeButton:!0,target:$(".rows_fields"),my:"right center",at:"left center",setup:function(a,b){Saiku.events.bind("queryToolbar:render_chart",this.onClickChartIcon);return{target:$(".query_toolbar_vertical")}},bind:["onClickChartIcon"],onClickChartIcon:function(a,b,e,f){a.next()}},{content:"\x3cp\x3eYou can now select from the different chart type Saiku offers.\x3c/p\x3eSaiku Enterprise users can set chart properties by clicking on the properties button.\x3c/p\x3e\x3cp\x3eYou can also export your chart to a file by clicking on the Export button.\x3c/p\x3e",
highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"right center",at:"left center",setup:function(a,b){Saiku.events.bind("queryToolbar:render_chart",this.onClickChartIcon);return{target:$(".query_toolbar_vertical")}},bind:["onClickChartIcon"],onClickChartIcon:function(a,b,e,f){a.next()}},{content:"\x3cp\x3eOn the workspace toolbar there are a number of useful buttons.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",at:"bottom center",
setup:function(a,b){return{target:$(".workspace_toolbar")}}},{content:"\x3cp\x3eEdit Query. This button will hide the query design area on the left of the workspace.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",at:"bottom center",setup:function(a,b){return{target:$('a[original-title\x3d"Edit query"]')}}},{content:"\x3cp\x3eRun Query/Automatic Execution. These icons allow you to manually run a query, or, toggle automatic query execution so that you have to exeucte the query manually.\x3c/p\x3e",
highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",at:"bottom center",setup:function(a,b){return{target:$('a[original-title\x3d"Run query"]')}}},{content:"\x3cp\x3eHide Parents. This button allows you to show the parent levels in the result set.\x3c/p\x3e\x3cp\x3eHidden by default, some queries are easier understood when you can see the data hierarchy.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",at:"bottom center",
setup:function(a,b){return{target:$('a[original-title\x3d"Hide Parents"]')}}},{content:"\x3cp\x3eNon Empty. This button hides null fields so minimise the resultset. Click this button to show the empty fields.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",at:"bottom center",setup:function(a,b){return{target:$('a[original-title\x3d"Non-empty"]')}}},{content:"\x3cp\x3eZoom. Zoom into a large table, by dragging over the area you want to show.\x3c/p\x3e",
highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",at:"bottom center",setup:function(a,b){return{target:$('a[original-title\x3d"Zoom into table"]')}}},{content:"\x3cp\x3eDrill Across. A way to discover more about your data. Select drill across and enable the required dimensions in the popup, the new result set will show you a more granular output of your previous query.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",
at:"bottom center",setup:function(a,b){return{target:$('a[original-title\x3d"Drill across on cell"]')}}},{content:"\x3cp\x3eDrill Through. Drill through to the lowest level to show how your query was constructed.\x3c/p\x3e",highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",at:"bottom center",setup:function(a,b){return{target:$('a[original-title\x3d"Drill through on cell"]')}}},{content:'\x3cp\x3eWe\'ve now run through the basics that Saiku Analytics has to offer. There is far more that we haven\'t explored so you might want to try one of the more advanced tutorials or just get started and explore yourself.\x3c/p\x3e\x3cp\x3eFor more help, visit \x3ca href\x3d"http://saiku-documentation.readthedocs.io/en/latest" target\x3d"_blank"\x3ehttp://saiku-documentation.readthedocs.io/en/latest\x3c/a\x3e.\x3c/p\x3e',
highlightTarget:!0,nextButton:!0,closeButton:!0,target:$(".rows_fields"),my:"top center",at:"bottom center",setup:function(a,b){return{target:$('a[original-title\x3d"Drill through on cell"]')}}}];(new Tourist.Tour({steps:b,stepOptions:{view:this.toolbar},tipClass:"QTip",tipOptions:{showEffect:"slidein"}})).start()}});